...
class Lead extends Model
{
    ...
    {
        $get_country=DB::select('select country_id,country_name from country');
        return $get_country;

    }
    public static function get_state($country_id)
    {
        $get_state=DB::select('select state_id,state_name from state where country_id="'.$country_id.'"');
        return $get_state;
    }
