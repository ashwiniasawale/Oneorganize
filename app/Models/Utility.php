...
class Utility extends Model
{
    ...
    public static function settings()
    {
        ...
        $settings = [
            ...
            "employee_prefix" => "3000",
            'leave_status' => '1',
            "bug_prefix" => "#ISSUE",
            'title_text' => 'One Organize',
            'footer_text' => '',
            ...
            "company_logo_dark" => "OneOrganizeLogo.png",
            ...
            'mail_port' => '465',
            'mail_username' => 'oneorganize@getmysolutions.in',
            'mail_password' => 'Gms@8087',
            'mail_encryption' => 'ssl',
            'mail_from_address' => 'oneorganize@getmysolutions.in',
            'mail_from_name' => 'ONE ORGANIZE',
