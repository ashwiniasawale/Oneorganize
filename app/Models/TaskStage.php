...
class TaskStage extends Model
{
    ...
    public function test($project_id)
    {
      if(\Auth::user()->type == 'company')
        return Test::where('stage_id', '=', $this->id)->where('project_id', '=', $project_id)->get();
      elseif(\Auth::user()->type == 'client'){
        return Test::where('stage_id', '=', $this->id)->where('project_id', '=', $project_id)->get();
      }
      else
        return Test::where('stage_id', '=', $this->id)->where('project_id', '=', $project_id)->whereRaw("find_in_set('" . \Auth::user()->id . "',assign_to)")->get();
    }
