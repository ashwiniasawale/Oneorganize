...
class Project extends Model
{
    ...
    public static function projectTask($id)
    {
        ...
        {
            $tasks   = ProjectTask::where('project_id', '=', $id)->orderBy('task_seq','asc')->get();
    ...
    public function project_progress($project,$last_task)
    {
        ...
        $completed_task = $project->tasks->where('stage_id',9)->count();
    ...
    {
        return $this->hasMany('App\Models\ProjectTask', 'project_id', 'id')->orderBy('task_seq', 'asc');
    }
