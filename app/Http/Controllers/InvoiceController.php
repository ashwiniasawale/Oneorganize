...
class InvoiceController extends Controller
{
    ...
    public function create($customerId)
    {
        if (\Auth::user()->can('create invoice')) {
            ...
            return view('invoice.create', compact('customers', 'invoice_number', 'product_services', 'category', 'customerId'));
        } else {
    ...
    public function show($ids)
    {
        ...
        if (\Auth::user()->can('show invoice')) {
            ...
            $invoice = Invoice::with(['creditNote','payments.bankAccount','items.product.unit'])->find($id);
                ...
                return view('invoice.view', compact('invoice', 'customer', 'iteams', 'invoicePayment', 'user', 'invoice_user', 'user_plan' , 'creditnote'));
