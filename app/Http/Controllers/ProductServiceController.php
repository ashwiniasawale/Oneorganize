...
class ProductServiceController extends Controller
{
    ...
    public function create()
    {
        if(\Auth::user()->can('create product & service'))
        {
            ...
            return view('productservice.create', compact('category', 'unit'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('create product & service'))
        {
            ...
            $productService->sgst_tax_rate       = $request->sgst_tax_rate;
            $productService->cgst_tax_rate       = $request->cgst_tax_rate;
            $productService->igst_tax_rate       = $request->igst_tax_rate;
    ...
    public function edit($id)
    {
        ...
        if(\Auth::user()->can('edit product & service'))
        {
                ...
                return view('productservice.edit', compact('category', 'unit','productService'));
