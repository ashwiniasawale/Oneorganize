...
class BillController extends Controller
{
    ...
    public function create($vendorId)
    {
        ...
        if(\Auth::user()->can('create bill'))
        {
            ...
            $category     = ProductServiceCategory::get()->pluck('name', 'id');
            ...
            return view('bill.create', compact('venders', 'bill_number', 'product_services', 'category', 'vendorId'));
        }
        else
        {
        ...
        if(\Auth::user()->can('create bill'))
        {
            ...
            for($i = 0; $i < count($products); $i++)
            {
                if(!empty($products[$i]['item']))
                {
                    ...
                    $billProduct->tax         = $products[$i]['itemTaxPrice'];
    ...
    public function show($ids)
    {
        ...
        if(\Auth::user()->can('show bill'))
        {
            ...
            $bill = Bill::find($id);
                ...
                return view('bill.view', compact('bill', 'vendor', 'item', 'billPayment'));
