...
class SetSalaryController extends Controller
{
    public function index()
    {
        ...
        if(\Auth::user()->can('manage set salary'))
        {
            ...
            $employees = Employee::where('is_active','=','1')->with('salaryType')->get();
    ...
    public function show($id)
    {
        ...
        if(\Auth::user()->type == 'Employee')
        {
            ...
            return view('setsalary.employee_salary', compact('employee', 'allowance_options',  'otherpayments', 'saturationdeductions','deduction_options', 'allowances'));
