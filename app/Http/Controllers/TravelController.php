...
class TravelController extends Controller
{
    ...
    public function create()
    {
        if(\Auth::user()->can('create travel'))
        {
            ...
            return view('travel.create', compact('employees','country'));
        }
        else
        {
    ...
    public function edit(Travel $travel)
    {
        ...
        if(\Auth::user()->can('edit travel'))
        {
            ...
            {
                $selected_country=$travel->place_of_visit;
              
            $country =Lead::get_country();
         
                return view('travel.edit',[ 'selected_country' => $selected_country,
                ], compact('travel', 'employees','country'),$country);
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
