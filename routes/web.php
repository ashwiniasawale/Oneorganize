...
use App\Http\Controllers\RequirementMatrixController;
...
//        Route::get('report/profit-loss-summary', [ReportController::class, 'profitLossSummary'])->name('report.profit.loss.summary');
    ...
    Route::get('employee-assets',[AssetController::class,'employee_assets'])->middleware(['auth','XSS','revalidate'])->name('employee-assets');
    Route::get('employee-assets/create',[AssetController::class,'create_employee_assets'])->middleware(['auth','XSS','revalidate'])->name('employee-assets.create');
    Route::post('employee_assets_store',[AssetController::class,'employee_assets_store'])->middleware(['auth','XSS','revalidate'])->name('employee_assets_store');
    Route::get('employee-assets/edit/{id}',[AssetController::class,'employee_assets_edit'])->middleware(['auth','XSS','revalidate'])->name('employee-assets.edit');
    Route::delete('employee-assets/destroy/{id}', [AssetController::class, 'employee_asset_destroy'])->middleware(['auth','XSS','revalidate'])->name('employee-assets.destroy');
    Route::post('employee-assets/update',[AssetController::class,'employee_assets_update'])->middleware(['auth','XSS','revalidate'])->name('employee_assets_update');
    ...
    Route::post('/leads/get_state', [LeadController::class, 'get_state'])->name('leads.get_state')->middleware(['auth', 'XSS']);
    ...
    Route::post('employee/dept_json', [EmployeeController::class, 'dept_json'])->name('employee.dept_json')->middleware(['auth', 'XSS']);
    ...
    Route::get('setsalary/otherpayment/{year_month?}',[OtherPaymentController::class,'other_payment'])->name('setsalary.otherpayment')->middleware(['auth', 'XSS']);
    Route::get('otherpayments/create', [OtherPaymentController::class, 'otherpaymentCreate'])->name('otherpayments.create')->middleware(['auth', 'XSS']);
    
    Route::post('otherpayments/store', [OtherPaymentController::class, 'store'])->name('otherpayment.store')->middleware(['auth', 'XSS']);
    Route::delete('otherpayments/destroy/{id}', [OtherPaymentController::class, 'destroy'])->name('otherpayment.destroy')->middleware(['auth', 'XSS']);
    
    Route::resource('overtime', OvertimeController::class)->middleware(['auth', 'XSS']);

    //Template Letters
    Route::get('letters/offer_letter',[TemplateLetterController::class,'offer_letter'])->name('offer.index')->middleware(['auth', 'XSS']);
    Route::get('letters/create_offer',[TemplateLetterController::class,'create_offer'])->name('letters.create_offer')->middleware(['auth', 'XSS']);
    Route::post('letters/store_offer',[TemplateLetterController::class,'store_offer'])->name('letters.storeoffer')->middleware(['auth','XSS']);
    Route::delete('letters/destroy/{id}',[TemplateLetterController::class,'destroy'])->name('offer.destroy')->middleware(['auth','XSS']);
    ...
    Route::delete('holidays/{holiday}', [HolidayController::class, 'destroy'])->name('holiday.destroy');
    Route::get('create_default_holiday',[HolidayController::class,'create_default_holiday'])->name('holiday.create_default_holiday')->middleware(['auth','XSS']);
    Route::post('mark_holiday_store',[HolidayController::class,'mark_holiday_store'])->middleware(['auth','XSS']);
    ...
    Route::get('export/task', [ProjectTaskController::class, 'task_export'])->name('task.export');
    ...
    Route::post('attendanceemployee/attendance_update/{id}',[AttendanceEmployeeController::class,'attendance_update'])->name('attendanceemployee.attendance_update')->middleware(['auth','XSS']);
    ...
    Route::get('leave/leave_details/{year?}',[LeaveController::class,'leave_details'])->name('leave.leave_details')->middleware(['auth','XSS']);

    Route::get('attendance_request',[AttendanceRequestController::class,'index'])->name('attendance_request')->middleware(['auth', 'XSS']);
    Route::get('attendance_request/create',[AttendanceRequestController::class,'create'])->name('attendance_request.create')->middleware(['auth','XSS']);
    Route::post('attendance_request/store',[AttendanceRequestController::class,'store'])->name('attendance_request.store')->middleware(['auth','XSS']);
    Route::get('attendance_request/{id}/edit',[AttendanceRequestController::class,'edit'])->name('attendance_request.edit')->middleware(['auth','XSS']);
    Route::post('attendance_request/update/{id}',[AttendanceRequestController::class,'update'])->name('attendance_request.update')->middleware(['auth','XSS']);
    Route::delete('attendance_request/{id}', [AttendanceRequestController::class, 'destroy'])->name('attendance_request.destroy')->middleware(['auth', 'XSS']);

    Route::post('leave/update_leave_status',[LeaveController::class,'update_leave_status'])->name('update.leave.update_leave_status')->middleware(['auth','XSS']);
    ...
    Route::post('leave/delete_leave',[LeaveController::class,'delete_leave'])->name('leave.delete_leave')->middleware(['auth','XSS']);

    Route::resource('leave', LeaveController::class)->middleware(['auth', 'XSS']);
    // Route::get('leave/{year?}', [LeaveController::class, 'index'])->name('leave.index');
   Route::get('leave/leave_year/{year?}', [LeaveController::class, 'leave_year'])->name('leave.leave_year')->middleware(['auth', 'XSS']);
    
  //  Route::resource('leave', LeaveController::class)->except(['index'])->middleware(['auth', 'XSS']);
    ...
    Route::get('projects/{id}/milestone', [ProjectController::class, 'milestonesCreate'])->name('project.milestone.create')->middleware(['auth', 'XSS']);
    ...
    Route::get('projects/{id}/gantt/{duration?}/{task_user_id?}/{task_stage_id?}', [ProjectController::class, 'gantt'])->name('projects.gantt')->middleware(['auth', 'XSS']);
    ...
    Route::get('/projects/{pid}/task/{sid}/{pos}/{tsid}', [ProjectTaskController::class, 'create'])->name('projects.tasks.create')->middleware(['auth', 'XSS']);
    ...
    Route::post('/projects/task/wbsupdate', [ProjectTaskController::class, 'wbsupdate'])->name('projects.tasks.wbsupdate')->middleware(['auth', 'XSS']);
    Route::post('/projects/task/get_updated_gantt',[ProjectTaskController::class, 'get_updated_gantt'])->name('projects.tasks.get_updated_gantt')->middleware(['auth', 'XSS']);
    Route::get('/projects/{id}/task/{tid}/req',[ProjectTaskController::class, 'req'])->name('task.req')->middleware(['auth', 'XSS']);
 
    Route::post('/projects/task/destroy', [ProjectTaskController::class, 'destroy'])->name('projects.tasks.destroy')->middleware(['auth', 'XSS']);
    ...
    Route::post('/projects/task/get_task_activity_type', [ProjectTaskController::class, 'get_task_activity_type'])->name('task.get_task_activity_type')->middleware(['auth', 'XSS']);
    Route::post('/projects/task/task_seq_update',[ProjectTaskController::class, 'task_seq_update'])->name('task.seq.update')->middleware(['auth', 'XSS']);
    Route::post('/projects/task/task_seq_change',[ProjectTaskController::class,'task_seq_change'])->name('task.seq.change')->middleware(['auth','XSS']);

    Route::get('/projects/{id}/subtask/{tid}', [ProjectTaskController::class, 'createsubtask'])->name('projects.tasks.createsubtask')->middleware(['auth', 'XSS']);
    Route::post('/projects/{pid}/subtask/{sid}', [ProjectTaskController::class, 'storesubtask'])->name('projects.tasks.storesubtask')->middleware(['auth', 'XSS']);
    Route::get('/projects/{id}/subtask/{tid}/{sid}/edit', [ProjectTaskController::class, 'editsubtask'])->name('projects.tasks.editsubtask')->middleware(['auth', 'XSS']);
    Route::post('/projects/{id}/subtask/update/{tid}/{sid}', [ProjectTaskController::class, 'updatesubtask'])->name('projects.tasks.updatesubtask')->middleware(['auth', 'XSS']);
...
//    Route::get('timesheet-table-view', [TimesheetController::class, 'filterTimesheetTableView'])->name('filter.timesheet.table.view')->middleware(['auth', 'XSS']);
    ...
    Route::post('estimatehours',[TimesheetController::class,'estimatehours'])->name('task.estimatehours')->middleware(['auth','XSS']);
    ...
    Route::group(
        [
            ...
            Route::get('projects/{id}/requirement_matrix', [ProjectController::class, 'requirementmatrix'])->name('project.requirementmatrix');
            Route::get('projects/{id}/requirement_matrix/create', [ProjectController::class, 'requirementmatrixCreate'])->name('project.requirementmatrix.create');
            Route::post('projects/{id}/requirement_matrix/store', [ProjectController::class, 'requirementmatrixStore'])->name('project.requirementmatrix.store');
            Route::get('projects/{id}/requirement_matrix/{rid}/edit', [ProjectController::class, 'requirementmatrixEdit'])->name('project.requirementmatrix.edit');
            Route::post('projects/{id}/requirement_matrix/{rid}/update',[ProjectController::class,'requirementmatrixUpdate'])->name('project.requirementmatrix.update');
            Route::delete('projects/{id}/requirement_matrix/{rid}/destroy', [ProjectController::class, 'requirementmatrixDestroy'])->name('project.requirementmatrix.destroy');
           
            Route::get('projects/{id}/test', [ProjectTestController::class, 'testIndex'])->name('project.testindex');
            Route::get('projects/{id}/test/kanban', [ProjectTestController::class, 'testKanban'])->name('projects.test.kanban');
            
            Route::get('projects/{id}/test/create/{sid}', [ProjectTestController::class, 'testCreate'])->name('projects.test.create')->middleware(['auth', 'XSS']);;
            Route::post('projects/{id}/test/store/{sid}', [ProjectTestController::class, 'testStore'])->name('project.test.store');
            Route::get('projects/{id}/test/{tid}/edit', [ProjectTestController::class, 'testEdit'])->name('project.test.edit');
            Route::post('projects/{id}/test/{tid}/update',[ProjectTestController::class,'testUpdate'])->name('project.test.update');
            Route::delete('projects/{id}/test/{tid}/destroy', [ProjectTestController::class, 'testDestroy'])->name('project.test.destroy');
           
            Route::get('projects/{id}/risk', [ProjectController::class, 'riskIndex'])->name('project.riskindex');
            Route::get('projects/{id}/risk/create', [ProjectController::class, 'riskCreate'])->name('project.risk.create');
            Route::post('projects/{id}/risk/store', [ProjectController::class, 'riskStore'])->name('project.risk.store');
            Route::get('projects/{id}/risk/{rid}/edit',[ProjectController::class, 'riskEdit'])->name('project.risk.edit');
            Route::post('projects/{id}/risk/{rid}/update',[ProjectController::class,'riskUpdate'])->name('project.risk.update');
            Route::delete('projects/{id}/risk/{rid}/destroy', [ProjectController::class, 'riskDestroy'])->name('project.risk.delete');
            ...
            Route::get('bugreport', [ProjectTaskController::class, 'bugreportView'])->name('project.buglist.view')->middleware(['auth', 'XSS']);

            Route::get('projects/{id}/review', [ReviewController::class, 'review'])->name('project.review.index');
            Route::get('projects/{id}/review/create', [ReviewController::class, 'reviewCreate'])->name('project.review.create');
            Route::post('projects/{id}/review/store', [ReviewController::class, 'reviewStore'])->name('project.review.store');
            Route::get('projects/{id}/review/{rid}/edit', [ReviewController::class, 'reviewEdit'])->name('project.review.edit');
            Route::post('projects/{id}/review/{rid}/update', [ReviewController::class, 'reviewUpdate'])->name('project.review.update');
            Route::delete('projects/{id}/review/{rid}/destroy', [ReviewController::class, 'reviewDestroy'])->name('project.review.destroy');
       
            Route::get('projects/{id}/communication', [CommunicationController::class, 'communication_record'])->name('project.communication.index');
            Route::get('projects/{id}/communication/create',[CommunicationController::class,'communiCreate'])->name('project.communication.create');
            Route::post('projects/{id}/communication/store',[CommunicationController::class,'communiStore'])->name('project.communication.store');
            Route::get('projects/{id}/communication/{cid}/edit',[CommunicationController::class,'communiEdit'])->name('project.communication.edit');
            Route::post('projects/{id}/communication/{cid}/update',[CommunicationController::class, 'communiUpdate'])->name('project.communication.update');
            Route::delete('projects/{id}/communication/{cid}/destroy', [CommunicationController::class, 'communiDestroy'])->name('project.communication.destroy');
...
//    Route::get('{id}/plan-get-payment-status', [PaypalController::class, 'planGetPaymentStatus'])->name('plan.get.payment.status')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::get('employee/pdf/{id}', [EmployeeController::class, 'offerletterPdf'])->name('offerletter.download.pdf');
    Route::get('employee/doc/{id}', [EmployeeController::class, 'joiningletterDoc'])->name('joininglatter.download.doc');
    
    // Working Letter
    Route::get('employee/pdff/{id}', [EmployeeController::class, 'WorkingletterPdf'])->name('working.download.pdf');
        
    // Salary Slip
    Route::get('employee/salarypdf/{id}', [EmployeeController::class, 'salarySlipPdf'])->name('salaryslip.download.pdf');

    //Increment Letter Pdf
    Route::get('employee/incrementpdf/{id}', [EmployeeController::class, 'IncrementLetterPdf'])->name('increment.download.pdf');

    // Appraisal Letter Pdf
    Route::get('employee/appraisalpdf/{id}', [EmployeeController::class, 'appraisalPdf'])->name('appraisal.download.pdf');
    ...
    Route::get('employee/relepdf/{id}',[EmployeeController::class,'RelLetterPdf'])->name('relieving.download.pdf');
    ...
    Route::get('employee/appointmentpdf/{id}', [EmployeeController::class, 'appointmentPdf'])->name('appointment.download.pdf');
