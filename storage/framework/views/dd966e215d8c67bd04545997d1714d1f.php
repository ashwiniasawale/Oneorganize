<?php echo e(Form::model($category, array('route' => array('product-category.update', $category->id), 'method' => 'PUT','id'=>'update_product_category'))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="category_update_button" value="<?php echo e(__('Update')); ?>" class="btn  btn-primary">
</div>
...
<script>
    ...
    $(document).ready(function () {
        $('#update_product_category').on('submit', function (e) {
            ...
            // Send AJAX request
            $("#category_update_button").attr("disabled", true);
            ...
            $.ajax({
                ...
                success: function (response) {
                 ...
                 $("#category_update_button").attr("disabled", false);
                  if(response.success)
                  {
...
</script><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/productServiceCategory/edit.blade.php ENDPATH**/ ?>