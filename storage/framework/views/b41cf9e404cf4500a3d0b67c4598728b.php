...
unset($__errorArgs, $__bag); ?>
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active m-1" id="pills-staff-tab" data-bs-toggle="pill" href="#staff" role="tab" aria-controls="pills-home" aria-selected="true"><?php echo e(__('Staff')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link m-1" id="pills-crm-tab" data-bs-toggle="pill" href="#crm" role="tab" aria-controls="pills-profile" aria-selected="false"><?php echo e(__('CRM')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link m-1" id="pills-project-tab" data-bs-toggle="pill" href="#project" role="tab" aria-controls="pills-contact" aria-selected="false"><?php echo e(__('Project')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link m-1" id="pills-hrmpermission-tab" data-bs-toggle="pill" href="#hrmpermission" role="tab" aria-controls="pills-contact" aria-selected="false"><?php echo e(__('HRM')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link m-1" id="pills-account-tab" data-bs-toggle="pill" href="#account" role="tab" aria-controls="pills-contact" aria-selected="false"><?php echo e(__('Account')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link m-1" id="pills-account-tab" data-bs-toggle="pill" href="#pos" role="tab" aria-controls="pills-contact" aria-selected="false"><?php echo e(__('POS')); ?></a>
                </li>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="project" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <?php
                        $modules=['project dashboard','project','milestone','grant chart','requirement matrix','communication record','project risk','project stage','timesheet','project expense','project task','project test','project review','activity','CRM activity','project task stage','bug report','bug status'];
                    ?>
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php if(!empty($permissions)): ?>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/role/create.blade.php ENDPATH**/ ?>