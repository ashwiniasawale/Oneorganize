    ...
    <div id="printableArea">
        ...
        <div>
           <p style="text-align: right; font-weight: bold;">Date:  <?php echo e(date('d/m/Y')); ?></p>
            ...
            ?>
                <h3 style="margin: 35px 0 10px 0; text-align: center;">Payslip for the month of <?php echo e($date->format('F Y')); ?></h3>
            </div>
        </div>
        ...
        <div>
            <table  style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    <td style="padding: 8px; text-align: left;"><span style="font-weight: bold;">PANCARD NO. :</span> <?php echo e($employee->tax_payer_id); ?></td>
                    <td style="padding: 8px; text-align: left;"><span style="font-weight: bold;">UAN NO :</span> <?php echo e($employee->UAN_NO); ?></td>
                </tr>
            </table>
        </div>
...
<?php  $PF1=0; ?>
                ...
                if($saturationdeduc->title=='PF Employee Contribution')
                {
                    $PF1 +=$saturationdeduc->amount;
                }else if($saturationdeduc->title=='PF Employeer Contribution')
                {
                    $PF1 +=$saturationdeduc->amount;?>
                    <td style="padding: 12px; text-align: left;">PF Contribution</td>
                    <td style="padding: 12px; text-align: left;"><?php echo e($PF1); ?> INR</td>
...
<?php
        ...
        <div style="display: flex; justify-content: space-between; margin-top: 25px;">
            ...
            <table style="border-collapse: collapse; width: 100%; margin-right: 10px;">
                ...
                ?>
                <tr>
                    <td style="padding: 12px; text-align: left;"><?php echo e($op->title); ?>(<?php echo e($op->payment_option); ?>)</td>
...
<script>
    ...
    function saveAsPDF() {
        ...
        var opt = {
            margin: 0.1,
            filename: 'GMS-Salary Slip-<?php echo e($employee->name); ?>.pdf',
...
<?php echo $__env->make('layouts.contractheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/payslip/pdf.blade.php ENDPATH**/ ?>