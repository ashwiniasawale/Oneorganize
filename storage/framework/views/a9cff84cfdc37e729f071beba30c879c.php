...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Appraisal Letter')); ?>
    ...
    <div id="boxes">
        ...
        <div
            ...
            <div style="margin: 5px 20px;">
                ...
                <p>Dear <?php echo e($employees->name); ?>,</p>
                ...
                <strong><?php echo e($obj['designation']); ?></strong> and revise your Cost to Company to <strong>INR <?php echo e($appraisal->appraisal_salary); ?></strong>, effective from <strong><?php echo e($appraisal->appraisal_date); ?></strong> The breakdown of your CTC is mentioned in Annexure A.</p>
        ...
        <script>
            ...
            $(window).on('load', function() {
                ...
                var opt = {
                    ...
                    filename: 'GMS-Appraisal Letter-<?php echo e($employees->name); ?>.pdf',
                    image: {
                        type: 'jpeg',
                        quality: 1
                    },
...
<?php echo $__env->make('layouts.contractheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/employee/template/appraisal_Letter_pdf.blade.php ENDPATH**/ ?>