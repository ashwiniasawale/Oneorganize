                ...
                success: function (data) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            const taxesObject = item.taxes[0];

                                // Iterate over the keys and values of the object
                                for (const [key, value] of Object.entries(taxesObject)) {

                                    if(value>0)
                                    {
                                        var key_data='';
                                        if(key=='sgst_tax_rate')
                                        {
                                            key_data='SGST';

                                        }else if(key=='cgst_tax_rate')
                                        {
                                            key_data='CGST';
                                        }else if(key=='igst_tax_rate')
                                        {
                                            key_data='IGST';
                                        }
                                        taxes += '<span class="badge bg-primary mt-1 mr-2">' +key_data+ ' ' + '(' + value + '%)' + '</span>&nbsp';
                                        
                                            totalItemTaxRate += parseFloat(value);
                                    }
                                }
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <?php echo e(Form::model($expense, array('route' => array('expense.update', $expense->id), 'method' => 'PUT','class'=>'w-100'))); ?>
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td width="25%" class="form-group pt-0">
                                        <?php echo e(Form::select('items', $product_services,null, array('class' => 'form-control select item','data-url'=>route('expense.product')))); ?>
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route("expense.index")); ?>';" class="btn btn-light me-3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/expense/edit.blade.php ENDPATH**/ ?>