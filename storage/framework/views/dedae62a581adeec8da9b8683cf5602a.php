<?php echo e(Form::open(array('route' => array('project.requirementmatrix.update',$project_id,$requirement->id),'method'=>'POST'))); ?>
...
<div class="modal-body">
    ...
    <div class="text-end">
        <a href="#" data-size="md" class="btn  btn-primary btn-icon btn-sm" data-ajax-popup-over="true" data-url="<?php echo e(route('generate',['project Requirement Matrics'])); ?>"
    ...
    <div class="row">
        ...
        <div class="form-group col-md-12 col-sm-12">
            <?php echo e(Form::label('requirement_details', __('Requirement Details'),['class'=>'form-label'])); ?>

            <?php echo Form::textarea('requirement_details',$requirement->requirement_details, ['class'=>'form-control','rows'=>'2']); ?>
        ...
        <?php echo e(Form::label('categories', __('Categories'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('implementable', __('Implementable'),['class'=>'form-label'])); ?>
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('testable', __('Testable'),['class'=>'form-label'])); ?>
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('implementation_status', __('Implimentation Status'),['class'=>'form-label'])); ?>
    ...
    <div class="row">
        <div class="form-group  col-md-12">
            <?php echo e(Form::label('testing_status', __('Testing Status'),['class'=>'form-label'])); ?>
...
<?php echo e(Form::close()); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/projects/requirementmatrixEdit.blade.php ENDPATH**/ ?>