<?php echo e(Form::open(array('url' => 'productservice','enctype' => "multipart/form-data",'id'=>'create_product'))); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::number('cgst_tax_rate', '0', array('class' => 'form-control','required'=>'required','step'=>'0.01','readonly'=>'readonly'))); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::number('sgst_tax_rate', '0', array('class' => 'form-control','required'=>'required','step'=>'0.01','readonly'=>'readonly'))); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::number('igst_tax_rate', '0', array('class' => 'form-control','required'=>'required','step'=>'0.01'))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="submit_product_button" value="<?php echo e(__('Create')); ?>" class="btn  btn-primary">
</div>
...
</script><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/productservice/create.blade.php ENDPATH**/ ?>