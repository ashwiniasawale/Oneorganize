<?php echo e(Form::model($vender,array('route' => array('vender.update', $vender->id), 'method' => 'PUT','id'=>'update_vender'))); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::number('billing_zip',null,array('class'=>'form-control'))); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <?php echo e(Form::number('shipping_zip',null,array('class'=>'form-control'))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="update_vender_button" value="<?php echo e(__('Update')); ?>" class="btn btn-primary">
</div>
...
</script><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/vender/edit.blade.php ENDPATH**/ ?>