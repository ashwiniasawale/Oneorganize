...
<?php echo e(Form::model($attendanceRequest,array('route' => array('attendance_request.update', $attendanceRequest->id),'id'=>'update_att_request', 'method' => 'POST'))); ?>
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-6 col-md-6 ">
            <div class="btn-box">
                ...
                <?php echo e(Form::date('date',$attendanceRequest->date, array('class' => 'form-control month-btn','id'=>'date','required'=>'required'))); ?>
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            <?php echo e(Form::time('clock_in',$attendanceRequest->clock_in,array('class'=>'form-control ','id'=>'clock_in','required'=>'required'))); ?>
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            <?php echo e(Form::time('clock_out',$attendanceRequest->clock_out,array('class'=>'form-control ','id'=>'clock_out','required'=>'required'))); ?>
        ...
        <div class="form-group col-lg-6 col-md-6">
           ...
           <?php echo e(Form::textarea('attendance_reason',$attendanceRequest->attendance_reason,array('class'=>'form-control','id'=>'attendance_reason','required'=>'required'))); ?>
...
<div class="modal-footer pr-0">
    <button type="button" id="update_attendance_request" class="btn dark btn-outline" data-dismiss="modal"><?php echo e(__('Cancel')); ?></button>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/attendanceRequest/edit.blade.php ENDPATH**/ ?>