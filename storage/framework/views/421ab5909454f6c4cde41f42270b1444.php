                    ...
                    <div class="table-responsive">
                        <table class="table datatable" id="att_table">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Relieving Letter')); ?></th>
                                <th><?php echo e(__('Experience Letter')); ?></th>
                            ...
                            <?php $__currentLoopData = $resignations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resignation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(route('relieving.download.pdf',$resignation->id)); ?>" class=" btn-icon btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="ti ti-download ">&nbsp;</i><?php echo e(__('PDF')); ?></a></td>
                                    <td><a href="<?php echo e(route('exp.download.pdf',$resignation->id)); ?>" class=" btn-icon btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="ti ti-download ">&nbsp;</i><?php echo e(__('PDF')); ?></a></td>
                                    <?php if(Gate::check('edit resignation') || Gate::check('delete resignation')): ?>
                                        <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/resignation/index.blade.php ENDPATH**/ ?>