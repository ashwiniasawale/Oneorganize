                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between w-100">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active m-1" id="payable-tab1" data-bs-toggle="pill" href="#vendor_balance"
                                    role="tab" aria-controls="pills-vendor-balance"
                                    aria-selected="true"><?php echo e(__('Vendor Balance')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link m-1" id="payable-tab2" data-bs-toggle="pill" href="#payable_summary"
                                    role="tab" aria-controls="pills-payable-summary"
                                    aria-selected="false"><?php echo e(__('Payable Summary')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link m-1" id="payable-tab3" data-bs-toggle="pill" href="#payable_details"
                                                ...
                                                <tr>
                                                    <?php
                                                        if ($payableSummary['bill']) {
                                                            $payableBalance = $payableSummary['price'] + $payableSummary['tax'];
                                                        } else {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/report/payable_report.blade.php ENDPATH**/ ?>