...
<?php $__env->startSection('content'); ?>
    ...
    <div id="printableArea">
        ...
        <div class="row">
            <div class="col">
            <i class="badge bg-warning p-2 rounded">H</i> - Holiday   
            <i class="badge bg-success p-2 rounded">P</i> - Present   
            <i class="badge bg-dark p-2 rounded">A</i> - Absent
            <i class="badge bg-danger p-2 rounded">L</i> - Leave
        
            <i class="fas fa-star-half-alt" style="color: #74C0FC;"></i> - Half Day Leave
            <i class="fas fa-star-half-alt" style="color: #FFD43B;"></i> - 2 Hours Leave
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $attendance['status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td>
                                                ...
                                                <i class="fas fa-star-half-alt" style="color: #74C0FC;"></i>
                                                <?php elseif($status=='two_hours_leave'): ?>
                                                <i class="fas fa-star-half-alt" style="color: #FFD43B;"></i>
                                                <?php elseif($status=='H'): ?>
                                                <i class="badge bg-warning p-2 rounded">H</i>
                                                <?php elseif($status=='L'): ?>
                                                <i class="badge bg-danger p-2 rounded">L</i>
                                                <?php elseif($status=='A'): ?>
                                                <i class="badge bg-dark p-2 rounded">A</i>
                                                <?php elseif($status==''): ?>
                                                -
                                                <?php endif; ?>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <td><?php echo e($attendance['totalempPresent']+$attendance['totalempHoliday']); ?>/<?php echo e($date); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/report/monthlyAttendance.blade.php ENDPATH**/ ?>