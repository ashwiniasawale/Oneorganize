                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <?php if($stage->name!='Delay'): ?>
                                  
                                    <?php endif; ?>
                                <?php endif; ?>
                                <h4 class="mb-0"><?php echo e($stage->name); ?>  (<?php echo count($tasks); ?>)</h4>
                            </div>
                                                ...
                                                <div class="btn-group card-option">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view project task')): ?>
                                                            <a href="#!" data-size="lg" data-url="<?php echo e(route('projects.tasks.show',[$project->id,$taskDetail->id])); ?>" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="<?php echo e(__('View')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/project_task/index.blade.php ENDPATH**/ ?>