<?php echo e(Form::open(['route' => 'employee_assets_update', 'method' => 'post','id'=>'update_employee_assets'])); ?>


<div class="modal-body">
  <div class="row">
  <div class="form-group col-md-6">
    <input type="hidden" name="ids" id="ids" value="<?php echo e($emp_asset->id); ?>">
  <?php echo e(Form::label('employee_id', __('Employee'),['class'=>'form-label'])); ?>

    <input type="text" class="form-control" disabled value="<?php echo e($employee->name); ?>" name="employee_id" id="employee_id">    
</div>
    ...
    <div id="asset-entries">
       ...
       ?>
        <div class="asset-entry row">
          ...
          ?>
          <select id="asset_id<?php echo e($i); ?>" name="asset_id[]" class="form-control" >
            <option value="<?php echo e($get_asset->id); ?>"> <?php echo e($get_asset->name); ?>(<?php echo e($get_asset->serial_number); ?>)</option>
          </select>
         </li>
...
<div class="modal-footer">
    ...
    <input type="submit" id="update_asset_submit" value="<?php echo e(__('Create')); ?>" class="btn btn-primary">
</div>

<?php echo e(Form::close()); ?>

<script>
    // Make sure `<?php echo json_encode($asset, 15, 512) ?>` provides the correct structure
    const assets = <?php echo json_encode($asset, 15, 512) ?>;

    let i = <?php echo e(count(explode(',', $emp_asset->asset_id))); ?>;
...
</script><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/employee_assets/edit.blade.php ENDPATH**/ ?>