...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Employee Assets')); ?></li>
<?php $__env->stopSection(); ?>
<?php
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create assets')): ?>
            <a href="#" data-url="<?php echo e(route('account-assets.create')); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Create Employee Assets')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"  class="btn btn-sm btn-primary">
                            ...
                            <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                   ...
                                   <td class="font-style"><?php echo e($asset->serial_number); ?></td>
                                    <td class="font-style"><?php echo e($asset->total_count); ?></td>
                                    <td class="font-style"><?php echo e($asset->status); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/assets/index.blade.php ENDPATH**/ ?>