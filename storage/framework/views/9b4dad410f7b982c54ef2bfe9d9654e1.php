<?php echo e(Form::model($bug, array('route' => array('task.bug.update', $project_id,$bug->id ), 'method' => 'POST'))); ?>
...
<div class="modal-body">
    ...
    <input type="hidden" id="p_start_date" value="<?php echo $project->start_date; ?>">
        ...
        <div class="form-group  col-md-6">
            ...
            <?php echo e(Form::date('start_date', null, array('class' => 'form-control','required'=>'required','id'=>'start_date','onchange'=>'getdate(this.value);'))); ?>

        </div>
        <div class="form-group  col-md-6">
            <?php echo e(Form::label('due_date', __('Due Date'),['class'=>'form-label'])); ?>

            <?php echo e(Form::date('due_date', null, array('class' => 'form-control','required'=>'required','id'=>'due_date'))); ?>
    ...
    <div class="form-group col-md-12">
            <?php echo e(Form::label('review', __('Review'),['class'=>'form-label'])); ?>

            <?php echo Form::select('review', $users, null,array('class' => 'form-control','required'=>'required')); ?>
...
var p_start_date=document.getElementById('p_start_date').value;
  ...
  document.getElementById("due_date").setAttribute("min", start_date);
   ...
   </script><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/projects/bugEdit.blade.php ENDPATH**/ ?>