...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::number('quantity',$productService->quantity, array('class' => 'form-control','required'=>'required'))); ?>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/productstock/edit.blade.php ENDPATH**/ ?>