...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
                ...
                <?php if(!empty($userPlan) && $userPlan->hrm == 1): ?>
                    <?php if(Gate::check('manage employee') || Gate::check('manage setsalary')): ?>
                        <li
                            ...
                            Request::segment(1)=='attendance_request' ||
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if(Gate::check('manage leave') || Gate::check('manage attendance')): ?>
                                    <li
                                        class="dash-item dash-hasmenu  <?php echo e(Request::segment(1) == 'leave' || Request::segment(1)=='attendance_request' || Request::segment(2) == 'leave_details' || Request::segment(1) == 'attendanceemployee' ? 'active dash-trigger' : ''); ?>">
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage attendance')): ?>
                                                <li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'attendanceemployee' ||  Request::segment(1)=='attendance_request' ? 'active dash-trigger' : ''); ?>"
                                                    ...
                                                    <ul class="dash-submenu">
                                                        <li
                                                            class="dash-item <?php echo e(Request::route()->getName() == 'attendanceemployee.index' ||  Request::segment(1)=='attendance_request' ? 'active' : ''); ?>">
                                                            <a class="dash-link"
                                ...
                                <li
                                        class="dash-item dash-hasmenu  <?php echo e(Request::segment(1) == 'letters' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'resignation' ? 'active dash-trigger' : ''); ?>">
                                        <a class="dash-link" href="#"><?php echo e(__('Templates')); ?><span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                           
                                                <li
                                                    class="dash-item <?php echo e(Request::route()->getName() == 'offer.index' ? 'active' : ''); ?>">
                                                    <a class="dash-link"
                                                        href="<?php echo e(route('offer.index')); ?>"><?php echo e(__('Offer/Appointment')); ?></a>
                                                </li>
                                                ...
                                                <li
                                                    ...
                                                    <a class="dash-link"
                                                        href="<?php echo e(route('appraisal.index')); ?>"><?php echo e(__('Appraisal/Increment')); ?></a>
                                                </li>
                                               <?php endif; ?>
                                               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage resignation')): ?>
                                                <li
                                                    ...
                                                    <a class="dash-link"
                                                        href="<?php echo e(route('resignation.index')); ?>"><?php echo e(__('Relieving/Experience')); ?></a>
                                                </li>
                                               <?php endif; ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage assets')): ?>
                                    <li class="dash-item <?php echo e(request()->is('employee-assets') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(route('employee-assets')); ?>"><?php echo e(__('Employees Asset')); ?></a>
                                    </li>
                                <?php endif; ?>
                        ...
                        <ul class="dash-submenu">
                                    ...
                                    <ul class="dash-submenu">
                                        <?php if(Gate::check('manage vender')): ?>
                                            <li
                                                ...
                                                <a class="dash-link"
                                                    href="<?php echo e(route('vender.index')); ?>"><?php echo e(__('Suppiler/Vendor')); ?></a>
                                            </li>
                                        <?php endif; ?>
                                        <li
                            ...
                            <?php if(Gate::check('manage constant tax') ||
                                ...
                                <li
                                    ...
                                    <a class="dash-link"
                                        href="<?php echo e(route('product-category.index')); ?>"><?php echo e(__('Accounting Setup')); ?></a>
                                </li>
                            <?php endif; ?>
            ...
            <?php if(Gate::check('manage project')): ?>
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        ...
                        <?php endif; ?>
                        <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'Manager'): ?>
            ...
            <li class="dash-item dash-hasmenu">
                <a href="#!" class="dash-link ">
                    <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span
                        class="dash-mtext"><?php echo e(__('Asset/Inventory')); ?></span><span class="dash-arrow">
                ...
                <ul class="dash-submenu">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage assets')): ?>
                                    <li class="dash-item <?php echo e(request()->is('account-assets*') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(route('account-assets.index')); ?>"><?php echo e(__('Asset Master')); ?></a>
                                    </li>
                                <?php endif; ?>
        ...
        <?php if(\Auth::user()->type != 'super admin'): ?>
            <?php if(Gate::check('manage company plan') || Gate::check('manage order') || Gate::check('manage company settings') || \Auth::user()->type == 'HR'): ?>
                <li
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>