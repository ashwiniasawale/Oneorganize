<?php echo e(Form::model($payment, array('route' => array('payment.update', $payment->id), 'id'=>'update_payment','method' => 'PUT','enctype' => 'multipart/form-data'))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="update_payment_button" value="<?php echo e(__('Update')); ?>" class="btn btn-primary">
</div>
...
<script>
     $(document).ready(function () {
        $('#update_payment').on('submit', function (e) {
            ...
            // Send AJAX request
            $("#update_payment_button").attr("disabled", true);
            ...
            $.ajax({
                ...
                success: function (response) {
                 ...
                 $("#update_payment_button").attr("disabled", false);
                  if(response.success)
                  {
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/payment/edit.blade.php ENDPATH**/ ?>