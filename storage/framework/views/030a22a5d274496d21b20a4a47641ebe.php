                        ...
                        <tbody class="list">
                            ...
                            <?php $__currentLoopData = $supports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $support): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td scope="row">
                                        <div class="media align-items-center">
                                            <a href="<?php echo e(route('support.reply',\Crypt::encrypt($support->id))); ?>" class="name h6 mb-0 text-sm text-break"><?php echo e($support->subject); ?></a><br>
                                        </div>
                                    </td>
                                    <td scope="row">
                                        <div class="media align-items-center">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/support/index.blade.php ENDPATH**/ ?>