<?php echo e(Form::open(array('url'=>'customer','method'=>'post','id'=>'create_customer'))); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('contact',null,array('class'=>'form-control','required'=>'required' , 'id'=>'phoneInput','pattern'=>"\d{10,12}",'minlength'=>'10','maxlength' => '12','placeholder'=>__('Enter Contact')))); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('billing_phone',null,array('class'=>'form-control' , 'id'=>'phoneInput','pattern'=>"\d{10,12}",'minlength'=>'10','maxlength' => '12', 'placeholder'=>__('Enter Phone')))); ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('billing_country',null,array('class'=>'form-control' ,'required'=>'required', 'placeholder'=>__('Enter Country')))); ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('billing_state',null,array('class'=>'form-control' ,'required'=>'required', 'placeholder'=>__('Enter State')))); ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('billing_city',null,array('class'=>'form-control' ,'required'=>'required', 'placeholder'=>__('Enter City')))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="submit_customer_button" value="<?php echo e(__('Create')); ?>" class="btn btn-primary">
</div>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/customer/create.blade.php ENDPATH**/ ?>