...
<div class="modal-body">
    ...
    <input type="hidden" id="task_seq" name="task_seq" value="<?php echo $task_seq; ?>">
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">
                <?php echo e(Form::label('milestone_id', __('Milestone'),['class' => 'form-label'])); ?> <small> (Optional)</small>
        ...
        <div class="col-12">
            <div class="form-group">
                <?php echo e(Form::label('description', __('Description'),['class' => 'form-label'])); ?> <small> (Optional)</small>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <?php echo e(Form::date('start_date', $project->start_date, ['class' => 'form-control','id'=>'start_date','required'=>'required','onchange'=>'getdate(this.value);'])); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="task_submit_button" value="<?php echo e(__('Create')); ?>" class="btn btn-primary">
</div>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/project_task/create.blade.php ENDPATH**/ ?>