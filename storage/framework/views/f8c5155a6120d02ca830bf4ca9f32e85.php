                ...
                <nav class="navbar navbar-expand-md default">
                    <div class="container">
                        ...
                        <a class="navbar-brand" href="#">
                            ...
                            <?php else: ?>
                                <img class="logo"
                                    src="<?php echo e($logo . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'OneOrganizeLogo.png') . '?' . time()); ?>"
                                    alt="" loading="lazy"/>
                            <?php endif; ?>
                        </a>
...
<?php /**PATH C:\xampp\htdocs\oneorganize\resources\views/layouts/auth.blade.php ENDPATH**/ ?>