<?php echo e(Form::open(array('route' => array('project.risk.update',$project_id,$risk->id),'method'=>'POST'))); ?>
...
<div class="modal-body overflow-scroll">
    ...
    <div class="row ">
        <div class="form-group col-md-6">
            ...
            <?php echo Form::textarea('risk_details', $risk->risk_details, ['class'=>'form-control','rows'=>'2','required'=>'required']); ?>
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            <?php echo Form::date('identified_on', $risk->identified_on, ['class'=>'form-control','rows'=>'2']); ?>
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            <?php echo Form::date('mitigation_target_date', $risk->mitigation_target_date, ['class'=>'form-control','rows'=>'2']); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo Form::textarea('risk_description',$risk->risk_description, ['class'=>'form-control','rows'=>'2']); ?>
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            <?php echo Form::text('risk_score', $risk->risk_score, ['class'=>'form-control','rows'=>'2','readonly'=>'readonly','id'=>'risk_score']); ?>

        </div>
        <div class="form-group col-md-6 col-sm-6">
            <?php echo e(Form::label('risk_consequence', __('Risk Consequence'),['class'=>'form-label'])); ?>

            <?php echo Form::textarea('risk_consequence', $risk->risk_consequence, ['class'=>'form-control','rows'=>'2']); ?>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo Form::textarea('critical_dependency', $risk->critical_dependency, ['class'=>'form-control','rows'=>'2','required'=>'required']); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('require_resource_for_mitigation', __('Require Resource for Mitigation'),['class'=>'form-label'])); ?>

            <?php echo Form::textarea('mitigation_resource', $risk->mitigation_resource, ['class'=>'form-control','rows'=>'2','required'=>'required']); ?>

        </div>
        <div class="form-group col-md-6 col-sm-6">
            <?php echo e(Form::label('financial_impact', __('Financial Impact'),['class'=>'form-label'])); ?>

            <?php echo Form::textarea('financial_impact', $risk->financial_impact, ['class'=>'form-control','rows'=>'2','required'=>'required']); ?>

        </div>
        <div class="form-group col-md-6 col-sm-6">
            <?php echo e(Form::label('timeline_impact', __('Timeline Impact'),['class'=>'form-label'])); ?>

            <?php echo Form::textarea('timeline_impact', $risk->timeline_impact, ['class'=>'form-control','rows'=>'2','required'=>'required']); ?>

        </div>
        <div class="form-group col-md-6 col-sm-6">
            <?php echo e(Form::label('action_item', __('Action Item'),['class'=>'form-label'])); ?>

            <?php echo Form::textarea('action_item', $risk->action_item, ['class'=>'form-control','rows'=>'2','required'=>'required']); ?>

        </div>
        <div class="form-group col-md-6 col-sm-6">
            <?php echo e(Form::label('action_taken', __('Action Taken'),['class'=>'form-label'])); ?>

            <?php echo Form::textarea('action_taken', $risk->action_taken, ['class'=>'form-control','rows'=>'2','required'=>'required']); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('changes_in_project_plan', __('Changes in Project plan'),['class'=>'form-label'])); ?>

            <?php echo Form::textarea('changes_in_project_plan', $risk->changes_in_project_plan, ['class'=>'form-control','rows'=>'2']); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('assumptions_made', __('Assumptions made'),['class'=>'form-label'])); ?>

            <?php echo Form::textarea('assumptions_made', $risk->assumptions_made, ['class'=>'form-control','rows'=>'2','required'=>'required']); ?>
...
</script><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/projects/riskEdit.blade.php ENDPATH**/ ?>