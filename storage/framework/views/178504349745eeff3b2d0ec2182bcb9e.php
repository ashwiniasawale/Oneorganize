<?php echo e(Form::model($revenue, array('route' => array('revenue.update', $revenue->id),'id'=>'update_revenue', 'method' => 'PUT','enctype' => 'multipart/form-data'))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="revenue_update_button" value="<?php echo e(__('Update')); ?>" class="btn  btn-primary">
</div>
...
</script><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/revenue/edit.blade.php ENDPATH**/ ?>