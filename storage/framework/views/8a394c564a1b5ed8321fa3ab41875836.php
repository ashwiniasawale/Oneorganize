                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                foreach ($receivableCustomers as $item) {
                                                    ...
                                                    $mergedArray[$name]['tax'] += floatval($item['tax']);
                                            ...
                                            <?php $__currentLoopData = $resultArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receivableCustomer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <?php
                                                        $customerBalance = $receivableCustomer['price'] + $receivableCustomer['tax'] - $receivableCustomer['pay_price'];
                                                ...
                                                <tr>
                                                    <?php
                                                        if ($receivableSummary['invoice']) {
                                                            $receivableBalance = $receivableSummary['price'] + $receivableSummary['tax'];
                                                        } else {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/report/receivable_report.blade.php ENDPATH**/ ?>