<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Appraisal/Increament')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Appraisal/Increment')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('action-btn'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create appraisal')): ?>
       <a href="#" data-size="lg" data-url="<?php echo e(route('appraisal.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create New Appraisal/Increament')); ?>" class="btn btn-sm btn-primary">
                    ...
                    <table class="table datatable" id="att_table">
                            ...
                            <tr>
                               <th><?php echo e(__('Employee')); ?></th>
                                ...
                                <th><?php echo e(__('Annual Salary')); ?></th>
                                <th><?php echo e(__('Appraisal')); ?></th>
                                <th><?php echo e(__('Increament')); ?></th>
                            ...
                            <?php $__currentLoopData = $appraisals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appraisal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td><?php echo e($appraisal->type); ?></td>
                                <td><?php echo e($appraisal->appraisal_date); ?></td>
                                <td><?php echo e($appraisal->appraisal_salary); ?></td>
                                <td>
                                    <?php if($appraisal->type=='Appraisal')
                                    { ?>
                                        <a href="<?php echo e(route('appraisal.download.pdf',$appraisal->id)); ?>" class=" btn-icon btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="ti ti-download ">&nbsp;</i><?php echo e(__('PDF')); ?></a>
                                    <?php } ?>
                                </td>
                                <td>
                                <?php if($appraisal->type=='Increament')
                                    { ?>
                                    <a href="<?php echo e(route('increment.download.pdf',$appraisal->id)); ?>" class=" btn-icon btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="ti ti-download ">&nbsp;</i><?php echo e(__('PDF')); ?></a>
                                    <?php  
                                    } ?>
                                </td>
                                    <?php if( Gate::check('edit appraisal') ||Gate::check('delete appraisal') || Gate::check('show appraisal')): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/appraisal/index.blade.php ENDPATH**/ ?>