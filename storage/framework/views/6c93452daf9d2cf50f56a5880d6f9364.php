<?php echo e(Form::model($customer,array('route' => array('customer.update', $customer->id), 'method' => 'PUT','id'=>'update_customer'))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="update_customer_button" value="<?php echo e(__('Update')); ?>" class="btn btn-primary">
</div>
...
<script>
  ...
  $(document).ready(function () {
      $('#update_customer').on('submit', function (e) {
          ...
          // Send AJAX request
          $("#update_customer_button").attr("disabled", true);
          ...
          $.ajax({
              ...
              success: function (response) {
               ...
               $("#update_customer_button").attr("disabled", false);
                if(response.success)
                {
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/customer/edit.blade.php ENDPATH**/ ?>