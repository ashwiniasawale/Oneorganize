...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::text('subject', '', array('class' => 'form-control ','required'=>'required','maxlength'=>'32'))); ?>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/support/create.blade.php ENDPATH**/ ?>