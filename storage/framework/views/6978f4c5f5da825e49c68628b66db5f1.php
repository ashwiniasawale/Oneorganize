...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create leave type')): ?>
            <a href="#" data-size="lg" data-url="<?php echo e(route('leavetype.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Leave Type')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"  class="btn btn-sm btn-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table datatable" id="att_table">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('No of Days')); ?></th>
                                <th><?php echo e(__('Monthly Limit')); ?></th>
                                <th><?php echo e(__('Leave Paid Status')); ?></th>
                                <th><?php echo e(__('Leave Year')); ?></th>
                            ...
                            <?php $__currentLoopData = $leavetypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leavetype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($leavetype->monthly_limit); ?></td>
                                    <td><?php echo e($leavetype->leave_paid_status); ?></td>
                                    <td><?php echo e($leavetype->leave_year); ?></td>
                                    <td>


                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit leave type')): ?>
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#" data-size="lg" class="mx-3 btn btn-sm align-items-center" data-url="<?php echo e(URL::to('leavetype/'.$leavetype->id.'/edit')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Leave Type')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php $__env->stopPush(); ?>        
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/leavetype/index.blade.php ENDPATH**/ ?>