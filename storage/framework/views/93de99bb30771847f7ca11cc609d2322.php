...
<div class="row ">
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('share project')): ?>
            <a href="#" class="btn btn-sm btn-primary p-2" data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Shared Project Settings')); ?>"
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view project risk')): ?>
            <a href="<?php echo e(route('project.riskindex',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
                <?php echo e(__('Risk')); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create milestone')): ?>
            ...
            <a href="#" data-size="lg" data-url="<?php echo e(route('project.milestone.create', $project->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary my-1" data-bs-original-title="<?php echo e(__('Create Milestone')); ?>">
                                   <?php echo e(__('Milestones')); ?>

                                </a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view communication record')): ?>
           <a href="<?php echo e(route('project.communication.index',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
                <?php echo e(__('Communication Record')); ?>

            </a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view requirement matrix')): ?>
            <a href="<?php echo e(route('project.requirementmatrix',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
                <?php echo e(__('Requirement Matrix')); ?>

            </a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view project task')): ?>
            <a href="<?php echo e(route('projects.gantt',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
                <?php echo e(__('WBS')); ?>

            </a>
        <?php endif; ?>
        <!-- <?php if(\Auth::user()->type!='client' || (\Auth::user()->type=='client' )): ?>
            <a href="<?php echo e(route('projecttime.tracker',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
                <?php echo e(__('Tracker')); ?>

            </a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view expense')): ?>
            <a href="<?php echo e(route('projects.expenses.index',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
        ...
        <?php if(\Auth::user()->type != 'client'): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view timesheet')): ?>
                <a href="<?php echo e(route('timesheet.index',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage bug report')): ?>
            <a href="<?php echo e(route('task.bug',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
                <?php echo e(__('Bug Report')); ?>

            </a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project test')): ?>
            <a href="<?php echo e(route('project.testindex',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
                <?php echo e(__('Test')); ?>

            </a>
        <?php endif; ?>
        <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create project task')): ?>
            <a href="<?php echo e(route('projects.tasks.index',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
                <?php echo e(__('Task')); ?>

            </a>
        <?php endif; ?> -->
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view project review')): ?>
            <a href="<?php echo e(route('project.review.index',$project->id)); ?>" class="btn btn-sm btn-primary m-1">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project')): ?>
            <a href="#" data-size="lg" data-url="<?php echo e(route('projects.edit', $project->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Edit Project')); ?>" class="btn btn-sm btn-primary p-2 m-1">
                    ...
                    <div class="row align-items-center justify-content-between mt-10">
                        <div class="col-auto mb-3 mb-sm-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <small class="text-muted h6"><?php echo e(__('Delay Task')); ?></small>
                                    <h6 class="m-0"><?php echo e($project_data['task']['delay']); ?></h6>
                                </div>
                             
                            </div>
                        </div>
                        <div class="col-auto text-end">
                            <small class="text-muted h6"><?php echo e(__('Inprogress Task')); ?></small>
                            <h4 class="m-0"><?php echo e($project_data['task']['inprogress']); ?></h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto text-end">
                            <h4 class="m-0">₹ <?php echo e($project->budget); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project')): ?>
                            <div class="float-end">
                                <a href="#" data-size="xl" data-url="<?php echo e(route('invite.project.member.view', $project->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Add Member')); ?>" title="Add Member" class="btn btn-sm btn-primary" data-bs-original-title="<?php echo e(__('Add Member')); ?>">
        ...
        <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create milestone')): ?>
                            <div class="">
                                <a href="#" data-size="lg" data-url="<?php echo e(route('project.milestone.create', $project->id)); ?>" title="Create Milestone" data-title="<?php echo e(__('Create Milestone')); ?>" data-ajax-popup="true"  class="btn btn-sm btn-primary" data-bs-original-title="<?php echo e(__('Create Milestone')); ?>">
                                    <i class="ti ti-plus"></i>
                                </a>
                            </div>
                        <?php endif; ?>
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="col-sm-auto text-sm-end d-flex align-items-center">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view milestone')): ?>
                                                ...
                                                <a href="#" data-size="lg" data-url="<?php echo e(route('project.milestone.show',$milestone->id)); ?>" data-ajax-popup="true" title="<?php echo e(__('View')); ?>" data-title="<?php echo e(__('View')); ?>" class="btn btn-sm" aria-label="View" >
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit milestone')): ?>
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" data-size="lg" data-url="<?php echo e(route('project.milestone.edit',$milestone->id)); ?>" data-ajax-popup="true"  title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Milestone')); ?>" class="btn btn-sm">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete milestone')): ?>
                                                <div class="action-btn bg-danger ms-2">
                                                    <?php echo Form::open(['method' => 'DELETE', 'class'=>'d-flex m-1','route' => ['project.milestone.destroy', $milestone->id]]); ?>

                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para"  title="<?php echo e(__('Delete')); ?>" data-title="<?php echo e(__('Delete')); ?>"><i class="ti ti-trash text-white"></i></a>
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="col-auto text-sm-end d-flex align-items-center">
                                            <div class="action-btn bg-info ms-2">
                                                <a href="<?php echo e($file.$attachment->file); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Download')); ?>" class="btn btn-sm" download>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/projects/view.blade.php ENDPATH**/ ?>