<?php echo e(Form::open(['route' => ['projects.tasks.updatesubtask',$subtask->project_id,$subtask->task_id,$subtask->id],'id' => 'edit_subtask'])); ?>
...
<div class="modal-body">
   ...
   ?>
    ...
    <div class="row">
        <input type="hidden" id="t_start_date" value="<?php echo e($task->start_date); ?>">
        <div class="col-6">
            <div class="form-group">
                <?php echo e(Form::label('name', __('Subtask Name'),['class' => 'form-label'])); ?><span class="text-danger">*</span>
                <?php echo e(Form::text('subtask_name', $subtask->subtask_name, ['class' => 'form-control','required'=>'required'])); ?>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('description', $subtask->description, ['class' => 'form-control','rows'=>'1','data-toggle' => 'autosize'])); ?>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('comment',$subtask->comment,['class'=>'form-control','rows'=>'1'])); ?>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('remark',$subtask->remark,['class'=>'form-control','rows'=>'1'])); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control select" name="priority" id="priority" required>
                    <?php $__currentLoopData = \App\Models\ProjectTask::$priority; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" <?php echo e(($key == $subtask->priority) ? 'selected' : ''); ?> ><?php echo e(__($val)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
                ...
                <?php echo e(Form::date('start_date', $subtask->start_date, ['class' => 'form-control','id'=>'start_date','required'=>'required','onchange'=>'getdate(this.value);'])); ?>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <?php echo e(Form::date('end_date', $subtask->end_date, ['class' => 'form-control','id'=>'end_date','required'=>'required'])); ?>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('deliverables', $subtask->deliverables, ['class' => 'form-control'])); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="edit_subtask_id" value="<?php echo e(__('Create')); ?>" class="btn btn-primary">
</div>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/project_task/editSubtask.blade.php ENDPATH**/ ?>