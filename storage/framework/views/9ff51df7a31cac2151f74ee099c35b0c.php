    ...
    <div class="row ">
        <div class="col-12">
            <div class="form-group">
                ...
                <?php echo e(Form::select('branch_id',$branch,null,array('class'=>'form-control select','required'=>'required','placeholder'=>__('Select Branch')))); ?>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/department/create.blade.php ENDPATH**/ ?>