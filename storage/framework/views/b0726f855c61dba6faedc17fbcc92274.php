<?php echo e(Form::open(array('route' => array('invoice.custom.credit.note'),'mothod'=>'post','id'=>'create_credit_note'))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="submit_credit_button" value="<?php echo e(__('Create')); ?>" class="btn  btn-primary">
</div>
...
<script>
     $(document).ready(function () {
        $('#create_credit_note').on('submit', function (e) {
            ...
            // Send AJAX request
            $("#submit_credit_button").attr("disabled", true);
            ...
            $.ajax({
                ...
                success: function (response) {
                 ...
                 $("#submit_credit_button").attr("disabled", false);
                  if(response.success)
                  {
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/creditNote/custom_create.blade.php ENDPATH**/ ?>