<?php echo e(Form::open(array('route' => array('project.communication.store',$project_id),'enctype' => 'multipart/form-data'))); ?>
...
<div class="modal-body">
    ...
    <div class="text-end">
        <a href="#" data-size="md" class="btn  btn-primary btn-icon btn-sm" data-ajax-popup-over="true" data-url="<?php echo e(route('generate',['project Communication'])); ?>"
...
<?php echo e(Form::close()); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/project_communication/communiCreate.blade.php ENDPATH**/ ?>