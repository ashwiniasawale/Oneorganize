                    ...
                    <div id="general" class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 mb-2 mt-4">
                                    <div class="d-flex align-items-start">
                                        <div class="theme-avtar bg-primary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/leads/show.blade.php ENDPATH**/ ?>