                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <div class="col-xl-3 col-lg-3 col-md-6">
                                <div class="btn-box ms-2">
                                    ...
                                    <?php echo e(Form::select('category', $category,  isset($_GET['category']) ? $_GET['category'] : '', ['class' => 'form-control select ','id'=>'choices-multiple', 'required' => 'required','style' => 'padding-right: 2.5rem;'])); ?>
                        ...
                        <table class="table datatable" id="att_table">
                            ...
                            <?php $__currentLoopData = $productServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="font-style">
                                    ...
                                    <td>
                                      CGST - ₹ <?php echo e($productService->cgst_tax_rate); ?><br>
                                      SGST - ₹ <?php echo e($productService->sgst_tax_rate); ?><br>
                                      IGST - ₹ <?php echo e($productService->igst_tax_rate); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/productservice/index.blade.php ENDPATH**/ ?>