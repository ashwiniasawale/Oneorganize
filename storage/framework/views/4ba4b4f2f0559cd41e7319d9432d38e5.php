...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        function load_data()
        {
           window.location.reload('<?php echo e(route('projects.index')); ?>');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/projects/index.blade.php ENDPATH**/ ?>