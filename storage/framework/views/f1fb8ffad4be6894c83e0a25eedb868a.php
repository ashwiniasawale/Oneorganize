                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center justify-content-end">
                            ...
                            <div class="col-xl-3 col-lg-2 col-md-6 col-sm-12">
                                <div class="btn-box pt-3 me-1 " id="department_div">
                            ...
                            <div class="col-xl-3 col-lg-2 col-md-6 col-sm-12">
                                <div class="btn-box pt-3 me-1 " id="employee_div">
    ...
    <div  class="mt-2">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class=" mb-0"><?php echo e(__('Total Salary')); ?> :</h6>
                    <h7 class="text-sm mb-0">₹ <?php echo e(round($filterData['totalSalary'])); ?></h7>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class="mb-0"><?php echo e(__('Total Gross Salary')); ?></h6>
                    <h7 class="text-sm mb-0">₹ <?php echo e(round($filterData['totalGrossSalary'])); ?></h7>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class=" mb-0"><?php echo e(__('Total Net Salary')); ?> :</h6>
                    <h7 class="text-sm mb-0">₹ <?php echo e(round($filterData['totalNetSalary'])); ?></h7>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class=" mb-0"><?php echo e(__('Total Deduction')); ?> :</h6>
                    <h7 class="text-sm mb-0">₹ <?php echo e(round($filterData['totalSaturationDeduction'])); ?></h7>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class=" mb-0"><?php echo e(__('Total Other Payment Allowance')); ?> :</h6>
                    <h7 class="text-sm mb-0">₹ <?php echo e(round($filterData['totalOtherPaymentAllowance'])); ?></h7>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
            <div class="card p-4 mb-4">
                    <h6 class=" mb-0"><?php echo e(__('Total Other Payment Deduction')); ?> :</h6>
                    <h7 class="text-sm mb-0">₹ <?php echo e(round($filterData['totalOtherPaymentDeduction'])); ?></h7>
                </div>
            </div>
                        ...
                        <table class="table   mb-0" >
                            ...
                            <?php $__currentLoopData = $payslips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payslip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>₹ <?php echo e(round($payslip->net_payble)); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/report/payroll.blade.php ENDPATH**/ ?>