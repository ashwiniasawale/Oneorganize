<?php echo e(Form::open(array('url'=>'vender','method'=>'post','id'=>'create_vender'))); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::number('billing_zip',null,array('class'=>'form-control' , 'placeholder' => __('Enter Zip Code')))); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <?php echo e(Form::number('shipping_zip',null,array('class'=>'form-control' , 'placeholder'=>__('Enter Zip Code')))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="submit_vender_button" value="<?php echo e(__('Create')); ?>" class="btn btn-primary">
</div>
...
<script>
    ...
    $(document).ready(function () {
        $('#create_vender').on('submit', function (e) {
            ...
            // Send AJAX request
            $("#submit_vender_button").attr("disabled", true);
            ...
            $.ajax({
                ...
                success: function (response) {
                 ...
                 $("#submit_vender_button").attr("disabled", false);
                  if(response.success)
                  {
...
</script><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/vender/create.blade.php ENDPATH**/ ?>