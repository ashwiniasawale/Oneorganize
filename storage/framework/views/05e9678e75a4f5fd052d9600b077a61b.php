    ...
    plotOptions: {
        radialBar: {
            ...
            dataLabels: {
                ...
                value: {
                    show: true, // Make sure the value is shown
                    fontSize: '20px',
                    formatter: function(val) {
                        // Format the value to show as raw data (e.g., in rupees)
                        return val;
                    }
                }
            }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>