<?php echo e(Form::model($attendanceEmployee,array('route' => array('attendanceemployee.update', $attendanceEmployee->id),'id'=>'edit_attend', 'method' => 'PUT'))); ?>
...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-lg-6  ">
            ...
            <?php echo e(Form::select('employee_id',$employees,null,array('class'=>'form-control select2','readonly'=>'readonly'))); ?>

        </div>
        <div class="form-group col-lg-6 ">
            <?php echo e(Form::label('date',__('Date'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::date('date',null,array('class'=>'form-control','readonly'=>'readonly'))); ?>
    ...
    <div class="row">
        <div class="form-group col-lg-6 ">
            ...
            <?php echo e(Form::time('clock_in',null,array('class'=>'form-control ','required'=>'required'))); ?>
        ...
        <div class="form-group col-lg-6 ">
            ...
            <?php echo e(Form::time('clock_out',null,array('class'=>'form-control ','required'=>'required'))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="edit_attend_button" value="<?php echo e(__('Update')); ?>" class="btn btn-primary">
</div>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/attendance/edit.blade.php ENDPATH**/ ?>