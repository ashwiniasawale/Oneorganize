<?php echo e(Form::open(array('url' => 'account-assets','id'=>'create_asset'))); ?>
...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('serial_number', '', array('class' => 'form-control','required'=>'required'))); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::number('total_count','', array('class' => 'form-control ','required'=>'required'))); ?>
...
<div class="modal-footer">
    ...
    <input type="submit" id="asset_submit_button" value="<?php echo e(__('Create')); ?>" class="btn  btn-primary">
</div>
...
<?php /**PATH D:\xampp\htdocs\oneorganize\resources\views/assets/create.blade.php ENDPATH**/ ?>