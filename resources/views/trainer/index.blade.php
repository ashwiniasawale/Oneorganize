...
@section('action-btn')
    ...
    @can('create trainer')
            ...
            <a href="#" id="openModalButton" data-size="lg" data-url="{{ route('trainer.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create New Trainer')}}" class="btn btn-sm btn-primary">
