{{ Form::open(['url' => 'mark_holiday_store', 'id'=>'mark_holiday','method' => 'post']) }}
   <style>
    .text-wrap{
        margin-right: 10px;
    }
   ...
   <div class="modal-body">
        ...
        <div class="row">
                <div class="col-md-12">
                    ...
                    { ?>
                    <option <?php if($current==$years){ echo 'selected=selected'; } ?> value="{{$years}}">{{$years}}</option>
                    <?php } ?>
                    </select>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    {{ Form::label('mark_days', __('Mark days for default Holidays'),['class'=>'form-label']) }}
    ...
    <div class="modal-footer">
        ...
        <input type="submit" id="create_mark_button" value="{{__('Create')}}" class="btn  btn-primary">
    </div>
