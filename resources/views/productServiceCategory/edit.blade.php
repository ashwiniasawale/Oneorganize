{{ Form::model($category, array('route' => array('product-category.update', $category->id), 'method' => 'PUT','id'=>'update_product_category')) }}
...
<div class="modal-footer">
    ...
    <input type="submit" id="category_update_button" value="{{__('Update')}}" class="btn  btn-primary">
</div>
{{ Form::close() }}
