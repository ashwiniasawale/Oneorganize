                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <div class="col-xl-3 col-lg-3 col-md-6">
                                <div class="btn-box ms-2">
                                    ...
                                    {{ Form::select('category', $category,  isset($_GET['category']) ? $_GET['category'] : '', ['class' => 'form-control select ','id'=>'choices-multiple', 'required' => 'required','style' => 'padding-right: 2.5rem;']) }}
                                </div>
                            </div>
                        ...
                        <table class="table datatable" id="att_table">
                            ...
                            @foreach ($productServices as $productService)
                                <tr class="font-style">
                                    ...
                                    <td>
                                      CGST - ₹ {{$productService->cgst_tax_rate}}<br>
                                      SGST - ₹ {{$productService->sgst_tax_rate}}<br>
                                      IGST - ₹ {{$productService->igst_tax_rate}}
                                    </td>
