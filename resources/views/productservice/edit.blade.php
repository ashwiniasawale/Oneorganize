{{ Form::model($productService, array('route' => array('productservice.update', $productService->id), 'method' => 'PUT','enctype' => "multipart/form-data",'id'=>'update_product')) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('cgst_tax_rate', $productService->cgst_tax_rate, array('class' => 'form-control','required'=>'required','step'=>'0.01')) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('sgst_tax_rate', __('SGST Tax Rate %'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {{ Form::number('sgst_tax_rate', $productService->sgst_tax_rate, array('class' => 'form-control','required'=>'required','step'=>'0.01')) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('igst_tax_rate', __('IGST Tax Rate %'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {{ Form::number('igst_tax_rate', $productService->igst_tax_rate, array('class' => 'form-control','required'=>'required','step'=>'0.01')) }}
            </div>
        </div>
...
<div class="modal-footer">
    ...
    <input type="submit" id="update_product_button" value="{{__('Update')}}" class="btn  btn-primary">
</div>
{{Form::close()}}
<script>
