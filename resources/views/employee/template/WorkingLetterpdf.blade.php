...
<div
        ...
        <div style="padding: 20px;">
            ...
            <div style="margin-bottom: 20px; ">
                ...
                <p style="margin: 5px 15px;  text-indent: 30px;">This is to certify that Mr/Mrs/Ms {{$obj['employee_name']}} has been employed in our company as a {{$obj['designation']}} from  {{ date('jS F, Y', strtotime($employees->company_doj))}}.</p>
...
@push('script-page')
    ...
    var opt = {
        margin: [0, 0, 0, 0],
        filename: 'GMS-Working letter-{{ $employees->name }}.pdf',
        image: {
            type: 'jpeg',
            quality: 1
        },
