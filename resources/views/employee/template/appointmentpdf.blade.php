...
<div id="boxes" style="padding-right:30px;padding-left:30px;">
    ...
    <img src="{{ asset('assets/images/logo/gms-logo.jpeg') }}" alt="gms-logo" style="width: 35%;">
    <div>
...
<br>
    <div style="padding-right:10px;padding-left:10px;font-family: Arial, sans-serif; text-align: justify;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <p><strong>Ref. No. {{$employees->ref_no}}</strong></p>
            <p><strong>Date: {{ Carbon::now()->format('F d, Y')}}</p></strong>
        </div>


        <p><strong>To,</strong> <br>
        {{$employees->title}} {{$obj['employee_name']}} <br>
            Pune.</p>
 
        <p style="text-align: center; font-weight: bold; "><u>Subject: Letter of
                Appointment<u></p>

        <p style="font-weight: bold;">Dear  {{$obj['employee_name']}},</p>

        <p>With reference to your acceptance of our offer letter dated <strong>{{ date('jS F, Y', strtotime($employees->offer_date))}}</strong>, the management is hereby pleased
            to appoint you in our organization <strong>GetMy Solutions Pvt. Ltd.</strong> w.e.f. <strong>{{ date('jS F, Y', strtotime($employees->joining_date))}}</strong> on the following terms &
            conditions:</p>

        <ol>
            <li>
               <strong><u>Designation:<u></strong>
                <p>You will be designated as <strong>{{$obj['designation']}}</strong> in the Product Development Department.</p>
            </li>
            <li>
        ...
        <div id="header" style="padding:0px;margin-top:105px;padding-top:0px;display: flex; align-items: start; justify-content: space-between; border-bottom: 1px solid black; ">
            <img src="{{ asset('assets/images/logo/gms-logo.jpeg') }}" alt="gms-logo" style="width: 35%;">
            <div>
                <h1 style="margin: 0; font-size: 16px;font-weight:700;">GetMy Solutions Pvt. Ltd.</h1>
                <span style="font-size: 6px; line-height: 1.2;">
        ...
        <ol>
            <li>
                ...
                such other and unrelated services and duties as may be assigned to {{$him_her}} from time to time by employer.
                </li>
                </ul>
                    </li>
                    <br>
            <li>
                ...
                <p>Employee agrees that {{$he_she}} will at all times faithfully, industriously, and to the best of {{$his_her}} ability,
                     experience, and talents, perform all of the duties that may be required of and from {{$him_her}} pursuant to the
            ...
            <li>
                ...
                <p>Employee shall devote all of {{$his_her}} time, attention, knowledge, and skills solely to the business and interest of employer, and employer 
            ...
            <div id="header" style="padding:0px;margin-top:70px;padding-top:0px;display: flex; align-items: start; justify-content: space-between; border-bottom: 1px solid black; ">
            <img src="{{ asset('assets/images/logo/gms-logo.jpeg') }}" alt="gms-logo" style="width: 35%;">
            <div>
                <h1 style="margin: 0; font-size: 16px;font-weight:700;">GetMy Solutions Pvt. Ltd.</h1>
                <span style="font-size: 6px; line-height: 1.2;">
        ...
        <br>
            ...
            <li>
                ...
                <p>Employee understands that in performance of {{$his_her}} job duties with the Company, Employee will be exposed to the Company's trade secrets. "Trade secrets"
            ...
            <div id="header" style="padding:0px;margin-top:45px;padding-top:0px;display: flex; align-items: start; justify-content: space-between; border-bottom: 1px solid black; ">
            <img src="{{ asset('assets/images/logo/gms-logo.jpeg') }}" alt="gms-logo" style="width: 35%;">
            <div>
                <h1 style="margin: 0; font-size: 16px;font-weight:700;">GetMy Solutions Pvt. Ltd.</h1>
                <span style="font-size: 6px; line-height: 1.2;">
        ...
        <br>
            <li>
                ...
                <p>The employee will keep the Company's trade secrets, whether or not prepared or developed by {{$him_her}},
                    in the strictest confidence. The employee will not use or disclose such secrets to others without
                    the Company's written consent except when necessary to perform {{$his_her}} job. However, the employee
                    shall have no obligation to treat as confidential any information which:</p>
                <ul style="list-style-type: upper-alpha;">
                    <li>Was in {{$his_her}} possession or known to {{$him_her}} without an obligation to keep it confidential
            ...
            <li>
                ...
                <p>Employee will not disclose to the Company, use in the Company's business, or cause the Company to use,
                     any information or material that is a trade secret of others. {{$his_her}} performance of this Agreement 
                     will not breach any agreement to keep in confidence proprietary information acquired by Employee prior to
                      {{$his_her}} employment by the Company.</p>

            </li>
            <li>
                <p><strong>RETURN OF MATERIALS</strong></p>
                <p>When {{$his_her}} employment with the Company ends, for whatever reason, Employee will promptly deliver to the Company
            ...
            <li>
                ...
                <p>Employee understand that {{$his_her}} obligation to maintain the confidentiality and security of the Company's trade
                     secrets remains with Employee even after {{$his_her}} employment with the Company ends and continues for so long as
                      such material remains a trade secret.</p>
            </li>

            <li>
                <p><strong>COMPUTER PROGRAM ARE WORKS MADE FOR HIRE </strong></p>
                <p>Employee understand that as part of {{$his_her}} job duties Employee may be asked to create, or
                    ...
                    that Employee is asked to prepare or work on as part of {{$his_her}} employment with the Company shall
        ...
        made for hire,employee hereby assign all {{$his_her}} copyright rights in the work to the company.</p>
            <li>
                ...
                <p>While Employee is employed by the Company, Employee will promptly inform the Company of the full
                    details of all {{$his_her}} inventions, discoveries, improvements, innovations and ideas (collectively
...
<br>
            <li>
                ...
                <p>Employee hereby assigns to the Company or the Company's designer, {{$his_her}} entire right, title and
            ...
            <li>
                ...
                <p>Employee will disclose to the Company any and all computer programs, inventions, improvements or
                    ...
                    after {{$his_her}} employment with the Company ends. Employee hereby assigns to the Company {{$his_her}}
                    entire right, title and interest in such programs, inventions, improvements and discoveries, whether
                    made individually or jointly, which relate to the subject matter of {{$his_her}} employment with the
                    Company during the 24 month period immediately preceding the termination of {{$his_her}} employment.
                </p>
            </li>
            ...
            <li>
                ...
                <div id="header" style="padding:0px;margin-top:42px;padding-top:0px;display: flex; align-items: start; justify-content: space-between; border-bottom: 1px solid black; ">
            <img src="{{ asset('assets/images/logo/gms-logo.jpeg') }}" alt="gms-logo" style="width: 35%;">
            <div>
                <h1 style="margin: 0; font-size: 16px;font-weight:700;">GetMy Solutions Pvt. Ltd.</h1>
                <span style="font-size: 6px; line-height: 1.2;">
        ...
        <br>
            ...
            <li>
                ...
                <p> Both while employed by the Company and afterwards, Employee agrees to execute and aid in the
                    ...
                    its expense. <br>
                    If the Company is unable to secure {{$his_her}} signature on any document necessary to obtain or
                    maintain any patent, copyright, trademark or other proprietary rights, whether due to {{$his_her}}
                    mental or physical capacity or any other cause, Employee hereby irrevocably designates and appoints
                    the Company and its duly authorized officers and agents as {{$his_her}} agents and attorneys-in-fact to
            ...
            <li>
                ...
                <p> During {{$his_her}} employment by the Company, Employee will not engage in any business activity
            ...
            <li>
                ...
                <p>Employee understand that during {{$his_her}} employment by the Company Employee may become Employee
                    ...
                    gravely harm the Company if Employee worked for a competitor. Accordingly, Employee agrees for <b> 2
                        years</b> following the end of {{$his_her}} employment with the Company not to compete, directly or
        ...
        <br>
            <p> <b>Diversion of Company Business: </b>For a period of
                    <b>2 years </b> from the date {{$his_her}} employment ends, Employee will not divert or attempt to
                    divert from the Company any business the Company enjoyed or solicited from its customers prior to
                    the termination of {{$his_her}} employment.</p>
            <li>
            ...
            <li >
                ...
                <p> The rights and obligations under this Agreement shall survive the termination of {{$his_her}} service
                    to the Company in any capacity and shall inure to the benefit and shall be binding upon: (1) {{$his_her}} heirs and personal representatives, and (2) the successors and assigns of the Company.</p>
            </li>
            ...
            <li>
                ...
                <p>The GetMy Solutions Pvt. Ltd., is an equal employment opportunity company and is committed to
                    ...
                    if involving employees is a grave offence and is, therefore, punishable. </p>
            </li>
            <div id="header" style="padding:0px;margin-top:0px;padding-top:0px;display: flex; align-items: start; justify-content: space-between; border-bottom: 1px solid black; ">
            <img src="{{ asset('assets/images/logo/gms-logo.jpeg') }}" alt="gms-logo" style="width: 35%;">
            <div>
        ...
        <br>
            <li>
                ...
                <p>  Please refer to our Policy
                document for more details.If any provision of this Agreement is determined to be invalid or unenforceable, the remainder shall
            ...
            <li style="margin-top:2em">
                ...
                <p> Employee is completely responsible for the Material provided to {{$him_her}} by Company. No personal
            ...
            <li>
                ...
                <p>This Agreement may be assigned by the Company. Employee may not assign or delegate {{$his_her}} duties
        ...
        <div id="header" style="padding:0px;margin-top:30px;padding-top:0px;display: flex; align-items: start; justify-content: space-between; border-bottom: 1px solid black; ">
            <img src="{{ asset('assets/images/logo/gms-logo.jpeg') }}" alt="gms-logo" style="width: 35%;">
            <div>
                <h1 style="margin: 0; font-size: 16px;font-weight:700;">GetMy Solutions Pvt. Ltd.</h1>
                <span style="font-size: 6px; line-height: 1.2;">
        ...
        <p>Employee has carefully read and considered all provisions of this Agreement and agrees that all of the
            ...
            acknowledges that {{$he_she}} has received a copy of this Agreement as signed by {{$him_her}}.</p>
   ...
   <p>Yours faithfully,</p>
        ...
        <div style="margin-top:17em; display: flex; align-items: start; justify-content: space-between; gap: 20px;">
            ...
            <div>
                <p>EMPLOYEE</p>
                <div style="margin-top: 2em;"> <span style="padding: 0; margin: 0; ">__</span>
                    <p style="padding: 0; margin: 0; font-size: 14px;">Authorized Signature</p>
                </div>

                <div style="margin-top: 2em;">
                    <span style="padding: 0; margin: 0;">__</span>
        ...
        <div id="header" style="padding:0px;margin-top:275px;padding-top:0px;display: flex; align-items: start; justify-content: space-between; border-bottom: 1px solid black; ">
            <img src="{{ asset('assets/images/logo/gms-logo.jpeg') }}" alt="gms-logo" style="width: 35%;">
            <div>
                <h1 style="margin: 0; font-size: 16px;font-weight:700;">GetMy Solutions Pvt. Ltd.</h1>
                <span style="font-size: 6px; line-height: 1.2;">
            ...
            <table style="border: none;  margin-top: 20px; font-weight: bold;">
               <tbody>
                <tr style="line-height:1.5px;">
                    ...
                    <td style="padding: 10px; text-align: left;">{{$employees->title}} {{$obj['employee_name']}}</td>
                </tr>
                <tr style="line-height:1.5px;">
                    <td style="padding: 10px; text-align: left;">Post</td>
                    <td style="padding: 10px; text-align: left;">:</td>
                    <td style="padding: 10px; text-align: left;">{{$obj['designation']}}  	</td>
                </tr>
                <tr style="line-height:1.5px;">
                    <td style="padding: 10px; text-align: left;">Joining Date</td>
                    <td style="padding: 10px; text-align: left;">:</td>
                    <td style="padding: 10px; text-align: left;">{{ date('jS F, Y', strtotime($employees->joining_date))}}</td>
                </tr>
                <tr>
               </tbody>
            </table>
        ...
        if (window.innerWidth <= 480) {
            format = 'a5';  // Narrower format for mobile devices
             ...
             var opt = {
                 ...
                 filename: 'GMS-Appointment Letter-{{$employees->employee_name}}.pdf',
