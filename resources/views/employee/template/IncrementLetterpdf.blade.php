...
<div id="boxes" style="width: 800px; max-width: 100%; margin: 0px auto; padding: 20px; background-color: #fff; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1); border-radius: 5px;">
        ...
        <div style="margin: 5px 25px 20px 25px;">
            ...
            <p>We hope this letter finds you in good health and high spirits. We are pleased to inform you that in recognition of your dedication, hard work, and exceptional performance over the past year, we have decided to offer you a salary increment effective from {{$increament->appraisal_date}}.</p>
            <p>Your revised salary details are as follows:</p>
            <ul>
               
                <li>Revised Salary: <strong>{{$increament->appraisal_salary}} INR</strong> per annum</li>
            </ul>
        ...
        <script>
            ...
            $(window).on('load', function() {
                ...
                var opt = {
                    ...
                    filename: 'GMS-Increment Letter-{{ $employees->name }}.pdf',
                    image: {
                        type: 'jpeg',
                        quality: 1
                    },
