...
{{ Form::open(['url' => 'appraisal', 'method' => 'post','id'=>'create_apprisal']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::month('appraisal_date', '', ['class' => 'form-control ','id'=>'appraisal_date','autocomplete'=>'off' ,'required' => 'required']) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                {{ Form::label('appraisal_salary', __('Salary (e.g. if 3 LPA then 300000)'), ['class' => 'col-form-label']) }}
                {{ Form::number('appraisal_salary', null, ['class' => 'form-control','id'=>'appraisal_salary','required'=>'required']) }}
            </div>
        </div>
    </div>
...
<div class="modal-footer">
    ...
    <input type="submit" id="appraisal_submit_button" value="{{ __('Create') }}" class="btn btn-primary">
</div>
{{ Form::close() }}
