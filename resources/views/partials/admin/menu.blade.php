...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                @if (Gate::check('manage leave') || Gate::check('manage attendance'))
                                    <li
                                        class="dash-item dash-hasmenu  {{ Request::segment(1) == 'leave' || Request::segment(1)=='attendance_request' || Request::segment(2) == 'leave_details' || Request::segment(1) == 'attendanceemployee' ? 'active dash-trigger' : '' }}">
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            @can('manage attendance')
                                                <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'attendanceemployee' ||  Request::segment(1)=='attendance_request' ? 'active dash-trigger' : '' }}"
                                                    ...
                                                    <ul class="dash-submenu">
                                                        <li
                                                            class="dash-item {{ Request::route()->getName() == 'attendanceemployee.index' ||  Request::segment(1)=='attendance_request' ? 'active' : '' }}">
                                                            <a class="dash-link"
                                ...
                                <li
                                        class="dash-item dash-hasmenu  {{ Request::segment(1) == 'letters' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'resignation' ? 'active dash-trigger' : ''   }}">
                                        <a class="dash-link" href="#">{{ __('Templates') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                           
                                                <li
                                                    class="dash-item {{ Request::route()->getName() == 'offer.index' ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('offer.index') }}">{{ __('Offer/Appointment') }}</a>
                                                </li>
                                                @can('manage appraisal')
                                                <li
                                                    class="dash-item {{ request()->is('appraisal*') ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('appraisal.index') }}">{{ __('Appraisal/Increment') }}</a>
                                                </li>
                                               @endcan
                                               @can('manage resignation')
                                                <li
                                                    ...
                                                    <a class="dash-link"
                                                        href="{{ route('resignation.index') }}">{{ __('Relieving/Experience') }}</a>
                                                </li>
                                               @endcan
                                ...
                                @can('manage assets')
                                    <li class="dash-item {{ request()->is('employee-assets') ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('employee-assets') }}">{{ __('Employees Asset') }}</a>
                                    </li>
                                @endcan
                                <!-- @can('manage document')
                        ...
                        <ul class="dash-submenu">
                                    ...
                                    <ul class="dash-submenu">
                                        @if (Gate::check('manage vender'))
                                            <li
                                                ...
                                                <a class="dash-link"
                                                    href="{{ route('vender.index') }}">{{ __('Suppiler/Vendor') }}</a>
                                            </li>
                                        @endif
                                        <li
                            ...
                            @if (Gate::check('manage constant tax') ||
                                ...
                                <li
                                    ...
                                    <a class="dash-link"
                                        href="{{ route('product-category.index') }}">{{ __('Accounting Setup') }}</a>
                                </li>
                            @endif
            ...
            <li class="dash-item dash-hasmenu">
                <a href="#!" class="dash-link ">
                    <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span
                        class="dash-mtext">{{ __('Asset/Inventory') }}</span><span class="dash-arrow">
                ...
                <ul class="dash-submenu">
                    ...
                    @can('manage assets')
                                    <li class="dash-item {{ request()->is('account-assets*') ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('account-assets.index') }}">{{ __('Asset Master') }}</a>
                                    </li>
                                @endcan
        ...
        @if (\Auth::user()->type != 'super admin')
            @if (Gate::check('manage company plan') || Gate::check('manage order') || Gate::check('manage company settings') || \Auth::user()->type == 'HR')
                <li
