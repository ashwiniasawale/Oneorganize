    ...
    <div id="printableArea">
        ...
        <div>
           <p style="text-align: right; font-weight: bold;">Date:  {{date('d/m/Y')}}</p>
            ...
            ?>
                <h3 style="margin: 35px 0 10px 0; text-align: center;">Payslip for the month of {{ $date->format('F Y') }}</h3>
            </div>
        </div>
        ...
        <div>
            <table  style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    <td style="padding: 8px; text-align: left;"><span style="font-weight: bold;">PANCARD NO. :</span> {{$employee->tax_payer_id}}</td>
                    <td style="padding: 8px; text-align: left;"><span style="font-weight: bold;">UAN NO :</span> {{$employee->UAN_NO}}</td>
                </tr>
            </table>
        </div>
...
<?php  $PF1=0; ?>
                ...
                }else if($saturationdeduc->title=='PF Employeer Contribution')
                {
                    ...
                    <td style="padding: 12px; text-align: left;">{{$PF1}} INR</td>
...
<script>
    ...
    function saveAsPDF() {
        ...
        var opt = {
            margin: 0.1,
            filename: 'GMS-Salary Slip-{{ $employee->name }}.pdf',
