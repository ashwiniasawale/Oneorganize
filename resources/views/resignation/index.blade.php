                    ...
                    <div class="table-responsive">
                        <table class="table datatable" id="att_table">
                            ...
                            <tr>
                                ...
                                <th>{{__('Relieving Letter')}}</th>
                                <th>{{__('Experience Letter')}}</th>
                            ...
                            @foreach ($resignations as $resignation)
                                <tr>
                                    ...
                                    <td><a href="{{route('relieving.download.pdf',$resignation->id)}}" class=" btn-icon btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="ti ti-download ">&nbsp;</i>{{__('PDF')}}</a></td>
                                    <td><a href="{{route('exp.download.pdf',$resignation->id)}}" class=" btn-icon btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="ti ti-download ">&nbsp;</i>{{__('PDF')}}</a></td>
                                    @if(Gate::check('edit resignation') || Gate::check('delete resignation'))
                                        <td>
