...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6 form-group">
            ...
            <a  target="_blank" href="{{asset(Storage::url('uploads/documentUpload')).'/'.$ducumentUpload->document}}"  data-title="{{ __('View Document') }}" title="{{ __('View') }}" class="btn btn-sm btn-primary">
