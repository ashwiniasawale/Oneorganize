...
@section('action-btn')
    <div class="float-end">
        ...
        @if($plan->chatgpt == 1)
            ...
            <a href="{{route('job.index')}}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" title="" data-bs-original-title="Back">
...
@section('content')
    ...
    <div class="row mt-3">
            ...
            <div class="card card-fluid">
                <div class="card-body job-create ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            {!! Form::label('position', __('Number of Positions'),['class'=>'form-label']) !!}
        ...
        <div class="col-md-12 text-end">
            <div class="form-group">
                <a href="{{route('job.index')}}" class="btn btn-light"  >{{ 'Cancel' }}</a>
