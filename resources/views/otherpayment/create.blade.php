{{Form::open(array('route' => 'otherpayment.store','method'=>'post','id'=>'create_payment'))}}
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('year_month', __('Year Month'),['class'=>'form-label']) }}
            {{ Form::month('year_month',date('Y-m'), array('class' => 'form-control ','required'=>'required')) }}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('payment_option', __('Payment Option'),['class'=>'form-label']) }}
...
<div class="modal-footer">
    ...
    <input type="submit" id="create_payment_button" value="{{__('Create')}}" class="btn  btn-primary">
</div>
