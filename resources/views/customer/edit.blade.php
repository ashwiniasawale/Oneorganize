{{Form::model($customer,array('route' => array('customer.update', $customer->id), 'method' => 'PUT','id'=>'update_customer')) }}
...
<div class="modal-footer">
    ...
    <input type="submit" id="update_customer_button" value="{{__('Update')}}" class="btn btn-primary">
</div>
{{Form::close()}}
