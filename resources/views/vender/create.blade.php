{{Form::open(array('url'=>'vender','method'=>'post','id'=>'create_vender'))}}
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                {{Form::number('billing_zip',null,array('class'=>'form-control' , 'placeholder' => __('Enter Zip Code')))}}
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    {{Form::number('shipping_zip',null,array('class'=>'form-control' , 'placeholder'=>__('Enter Zip Code')))}}
                </div>
            </div>
...
<div class="modal-footer">
    ...
    <input type="submit" id="submit_vender_button" value="{{__('Create')}}" class="btn btn-primary">
</div>
{{Form::close()}}
