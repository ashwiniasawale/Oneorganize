...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Vendor/Supplier')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
        ...
        @can('create vender')
            <a href="#" data-size="lg" data-url="{{ route('vender.create') }}" data-ajax-popup="true" data-title="{{__('Create New Vendor/Supplier')}}" data-bs-toggle="tooltip" title="{{ __('Create') }}" class="btn btn-sm btn-primary">
