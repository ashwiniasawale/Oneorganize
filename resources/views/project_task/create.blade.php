...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">
                {{ Form::label('milestone_id', __('Milestone'),['class' => 'form-label']) }} <small> (Optional)</small>
        ...
        <div class="col-12">
            <div class="form-group">
                {{ Form::label('description', __('Description'),['class' => 'form-label']) }} <small> (Optional)</small>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                {{ Form::date('start_date', $project->start_date, ['class' => 'form-control','id'=>'start_date','required'=>'required','onchange'=>'getdate(this.value);']) }}
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
...
<div class="modal-footer">
    ...
    <input type="submit" id="task_submit_button" value="{{__('Create')}}" class="btn btn-primary">
</div>
{{Form::close()}}
