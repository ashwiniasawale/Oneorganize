                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                @if($stage->name!='Delay')
                                    ...
                                    @endif
                                @endcan
                                <h4 class="mb-0">{{$stage->name}}  (<?php echo count($tasks); ?>)</h4>
                            </div>
                                                ...
                                                <div class="btn-group card-option">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @can('view project task')
                                                            <a href="#!" data-size="lg" data-url="{{ route('projects.tasks.show',[$project->id,$taskDetail->id]) }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('View')}}">
