{{ Form::model($payment, array('route' => array('payment.update', $payment->id), 'id'=>'update_payment','method' => 'PUT','enctype' => 'multipart/form-data')) }}
...
<div class="modal-footer">
    ...
    <input type="submit" id="update_payment_button" value="{{__('Update')}}" class="btn btn-primary">
</div>
{{ Form::close() }}
