...
@section('action-btn')
    <div class="float-end">
        @can('create leave type')
            <a href="#" data-size="lg" data-url="{{ route('leavetype.create') }}" data-ajax-popup="true" data-title="{{__('Create New Leave Type')}}" data-bs-toggle="tooltip" title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                        ...
                        <table class="table datatable" id="att_table">
                            ...
                            @foreach ($leavetypes as $leavetype)
                                <tr>
                                    ...
                                    <td>{{$leavetype->monthly_limit}}</td>
                                    <td>{{$leavetype->leave_paid_status}}</td>
                                    <td>{{$leavetype->leave_year}}</td>
                                    <td>


                                        @can('edit leave type')
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#" data-size="lg" class="mx-3 btn btn-sm align-items-center" data-url="{{ URL::to('leavetype/'.$leavetype->id.'/edit') }}" data-ajax-popup="true" data-title="{{__('Edit Leave Type')}}" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
