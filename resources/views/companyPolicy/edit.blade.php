...
{{--                    <img id="image" class="mt-3" style="width:25%;"/>--}}
            ...
            <a  target="_blank" href="@if($companyPolicy->attachment){{$policyPath.$companyPolicy->attachment}}@else{{$logo.'user-2_1654779769.jpg'}}@endif"  data-title="{{ __('View Document') }}" title="{{ __('View') }}" class="btn btn-sm btn-primary">
