{{ Form::open(array('route' => array('project.risk.store',$project_id))) }}
<div class="modal-body overflow-scroll">
    ...
    <div class="row ">
        <div class="form-group col-md-6">
            ...
            {!! Form::textarea('risk_details', null, ['class'=>'form-control','rows'=>'2','required'=>'required']) !!}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            {!! Form::date('identified_on', null, ['class'=>'form-control','rows'=>'2']) !!}
        </div>

        <div class="form-group col-md-6 col-sm-6">
            {{ Form::label('mitigation_target_date', __('Mitigation Target Date'),['class'=>'form-label']) }}
            {!! Form::date('mitigation_target_date', null, ['class'=>'form-control','rows'=>'2']) !!}
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            {!! Form::textarea('risk_description', null, ['class'=>'form-control','rows'=>'2']) !!}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            {!! Form::text('risk_score', null, ['class'=>'form-control','rows'=>'2','readonly'=>'readonly','id'=>'risk_score']) !!}
        </div>
        <div class="form-group col-md-6 col-sm-6">
            {{ Form::label('risk_consequence', __('Risk Consequence'),['class'=>'form-label']) }}
            {!! Form::textarea('risk_consequence', null, ['class'=>'form-control','rows'=>'2']) !!}
        </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {!! Form::textarea('critical_dependency', null, ['class'=>'form-control','rows'=>'2','required'=>'required']) !!}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('require_resource_for_mitigation', __('Require Resource for Mitigation'),['class'=>'form-label']) }}
            {!! Form::textarea('mitigation_resource', null, ['class'=>'form-control','rows'=>'2','required'=>'required']) !!}
        </div>
        <div class="form-group col-md-6 col-sm-6">
            {{ Form::label('financial_impact', __('Financial Impact'),['class'=>'form-label']) }}
            {!! Form::textarea('financial_impact', null, ['class'=>'form-control','rows'=>'2','required'=>'required']) !!}
        </div>
        <div class="form-group col-md-6 col-sm-6">
            {{ Form::label('timeline_impact', __('Timeline Impact'),['class'=>'form-label']) }}
            {!! Form::textarea('timeline_impact', null, ['class'=>'form-control','rows'=>'2','required'=>'required']) !!}
        </div>
        <div class="form-group col-md-6 col-sm-6">
            {{ Form::label('action_item', __('Action Item'),['class'=>'form-label']) }}
            {!! Form::textarea('action_item', null, ['class'=>'form-control','rows'=>'2','required'=>'required']) !!}
        </div>
        <div class="form-group col-md-6 col-sm-6">
            {{ Form::label('action_taken', __('Action Taken'),['class'=>'form-label']) }}
            {!! Form::textarea('action_taken', null, ['class'=>'form-control','rows'=>'2','required'=>'required']) !!}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('changes_in_project_plan', __('Changes in Project plan'),['class'=>'form-label']) }}
            {!! Form::textarea('changes_in_project_plan', null, ['class'=>'form-control','rows'=>'2']) !!}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('assumptions_made', __('Assumptions made'),['class'=>'form-label']) }}
            {!! Form::textarea('assumptions_made', null, ['class'=>'form-control','rows'=>'2','required'=>'required']) !!}
        </div>
    </div>
