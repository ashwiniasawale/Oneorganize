...
{{ Form::open(['route' => ['project.test.store',$project_id,$stage_id],'id' => 'create_test','method'=>'POST','enctype'=>'multipart/form-data']) }}
<style>
    .choices__inner{
   ...
   <input type="hidden" id="p_end_date" value="<?php echo $project->end_date; ?>">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            {{ Form::text('test_name', '', array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="col-6">
...
<div class="form-group">
                ...
                {{ Form::date('start_date', $project->start_date, ['class' => 'form-control','required'=>'required','id'=>'start_date','onchange'=>'getdate(this.value);']) }}
            </div>
</div>
<div class="col-6">
<div class="form-group">
