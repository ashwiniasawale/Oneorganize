...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Milestone')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
        ...
        @can('create bug report')
            <a href="#" data-size="lg" data-url="{{ route('project.milestone.create',$project->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create New Milestone')}}" class="btn btn-sm btn-primary">
