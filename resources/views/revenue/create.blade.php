{{ Form::open(array('url' => 'revenue','enctype' => 'multipart/form-data','id'=>'create_revenue')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('amount', '', array('class' => 'form-control','required'=>'required', 'placeholder'=>__('Enter Amount'))) }}
        </div>
...
<div class="modal-footer">
    ...
    <input type="submit" id="revenue_submit_button" value="{{__('Create')}}" class="btn  btn-primary">
</div>
{{ Form::close() }}
