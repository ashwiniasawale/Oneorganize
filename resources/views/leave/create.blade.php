{{Form::open(array('url'=>'leave','method'=>'post','id'=>'create_leave'))}}
        ...
        @endif
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{Form::date('start_date',null,array('class'=>'form-control','id'=>'start_date','required'=>'required','onchange'=>'min_end_date();'))}}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{Form::textarea('leave_reason',null,array('class'=>'form-control','id'=>'leave_reason','required'=>'required','placeholder'=>__('Leave Reason')))}}
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer">
        ...
        <input type="submit" id="create_leave_button" value="{{__('Create')}}" class="btn  btn-primary">
    </div>
{{Form::close()}}
<script>
