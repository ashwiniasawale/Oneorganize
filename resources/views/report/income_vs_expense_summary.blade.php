                        ...
                        <div class="row align-items-center justify-content-end">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                                        <div class="btn-box">
                                            {{ Form::label('period', __('Income Period'),['class'=>'form-label pt-3']) }}
                                    ...
                                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                                        <div class="btn-box">
                                            {{ Form::label('year', __('Year'),['class'=>'form-label pt-3'])}}
                                    ...
                                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                                        <div class="btn-box">
                                            {{ Form::label('category', __('Category'), ['class' => 'form-label pt-3']) }}
                                            {{ Form::select('category', $category, isset($_GET['category']) ? $_GET['category'] : '', ['class' => 'form-control select px-1']) }}
                                        </div>
                                    </div>

                                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                                        <div class="btn-box">
                                            {{ Form::label('customer', __('Customer'), ['class' => 'form-label pt-3']) }}
                                            {{ Form::select('customer', $customer, isset($_GET['customer']) ? $_GET['customer'] : '', ['class' => 'form-control select px-1']) }}
                                        </div>
                                    </div>

                                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                                        <div class="btn-box">
                                            {{ Form::label('vender', __('Vendor'), ['class' => 'form-label pt-3']) }}
