    ...
    <div  class="mt-2">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class=" mb-0">{{__('Total Salary')}} :</h6>
                    <h7 class="text-sm mb-0">₹ {{round($filterData['totalSalary'])}}</h7>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class="mb-0">{{__('Total Gross Salary')}}</h6>
                    <h7 class="text-sm mb-0">₹ {{round($filterData['totalGrossSalary'])}}</h7>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class=" mb-0">{{__('Total Net Salary')}} :</h6>
                    <h7 class="text-sm mb-0">₹ {{round($filterData['totalNetSalary'])}}</h7>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class=" mb-0">{{__('Total Deduction')}} :</h6>
                    <h7 class="text-sm mb-0">₹ {{round($filterData['totalSaturationDeduction'])}}</h7>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h6 class=" mb-0">{{__('Total Other Payment Allowance')}} :</h6>
                    <h7 class="text-sm mb-0">₹ {{round($filterData['totalOtherPaymentAllowance'])}}</h7>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
            <div class="card p-4 mb-4">
                    <h6 class=" mb-0">{{__('Total Other Payment Deduction')}} :</h6>
                    <h7 class="text-sm mb-0">₹ {{round($filterData['totalOtherPaymentDeduction'])}}</h7>
                </div>
            </div>
                        ...
                        <table class="table   mb-0" >
                            ...
                            @foreach($payslips as $payslip)
                                <tr>
                                    ...
                                    <td>₹ {{round($payslip->net_payble)}}</td>
