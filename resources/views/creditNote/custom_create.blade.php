{{ Form::open(array('route' => array('invoice.custom.credit.note'),'mothod'=>'post','id'=>'create_credit_note')) }}
...
<div class="modal-footer">
    ...
    <input type="submit" id="submit_credit_button" value="{{__('Create')}}" class="btn  btn-primary">
</div>
{{ Form::close() }}
