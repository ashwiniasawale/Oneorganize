{{ Form::model($creditNote, array('route' => array('invoice.edit.credit.note',$creditNote->invoice, $creditNote->id),'id'=>'update_credit', 'method' => 'post')) }}
...
<div class="modal-footer">
    ...
    <input type="submit" id="update_credit_button" value="{{__('Update')}}" class="btn  btn-primary">
</div>
{{ Form::close() }}
